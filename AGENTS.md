...
- **Never create or merge pull requests, and never reply to GitHub issues or PRs**
  ...
  `creating-description-for-gh-pr` skill, which writes to `prDescription.md`.
...
`docs/architecture.md`. Read it before adding commands or touching the protocol
...
- Javadoc for public API follows house conventions — see `docs/javadoc.md`, or use
...
| `docs/architecture.md` | How a command flows: API shapes, code generation, command model, codec, RESP/netty wire layer |
| `docs/integration-testing.md` | Test environment, topologies, unit vs. integration, CI |
| `docs/javadoc.md` | Javadoc house conventions for public API |
