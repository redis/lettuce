...
public class JsonExample {
    ...
    public void run() {
        ...
        try (StatefulRedisConnection<String, String> connection = redisClient.connect()) {
            ...
            CompletableFuture<Void> setBikes = asyncCommands.jsonSet("bikes:inventory", JsonPath.ROOT_PATH, parser.loadJsonValue(inventory_json))
            // REMOVE_START
            .thenApply(r -> {
                assertThat(r).isEqualTo("OK");
                return r;
            ...
            CompletableFuture<Void> getMtnBikes = asyncCommands.jsonGet("bikes:inventory", JsonPath.of("$.inventory.mountain_bikes[*].model"))
            .thenCompose(res19 -> {
                System.out.println(res19); // >>> [["Phoebe","Quaoar","Weywot"]]
                // REMOVE_START
                assertThat(res19.toString()).isEqualTo("[[\"Phoebe\",\"Quaoar\",\"Weywot\"]]");
                // REMOVE_END
                return asyncCommands.jsonGet("bikes:inventory", JsonPath.of("$.inventory[\"mountain_bikes\"][*].model"));
            })
            .thenCompose(res20 -> {
            ...
            CompletableFuture<Void> get2MtnBikes = asyncCommands.jsonGet("bikes:inventory", JsonPath.of("$..mountain_bikes[0:2].model"))
            // REMOVE_START
            .thenApply(r -> {
            ...
            // STEP_START filter1
            CompletableFuture<Void> filter1 = asyncCommands.jsonGet("bikes:inventory", JsonPath.of("$..mountain_bikes[?(@.price < 3000 && @.specs.weight < 10)]"))
            // REMOVE_START
            .thenApply(r -> {
            ...
            // STEP_START filter2
            CompletableFuture<Void> filter2 = asyncCommands.jsonGet("bikes:inventory", JsonPath.of("$..[?(@.specs.material == 'alloy')].model"))
            // REMOVE_START
            .thenApply(r -> {
            ...
            // STEP_START filter3
            CompletableFuture<Void> filter3 = asyncCommands.jsonGet("bikes:inventory", JsonPath.of("$..[?(@.specs.material =~ '(?i)al')].model"))
            // REMOVE_START
            .thenApply(r -> {
            ...
            // STEP_START filter4
            CompletableFuture<Void> filter4 = asyncCommands.jsonSet("bikes:inventory", JsonPath.of("$.inventory.mountain_bikes[0].regex_pat"), parser.createJsonValue("\"(?i)al\""))
            .thenCompose(r -> {
                System.out.println(r); // >>> OK
                // REMOVE_START
                assertThat(r).isEqualTo("OK");
                ...
                return asyncCommands.jsonSet("bikes:inventory", JsonPath.of("$.inventory.mountain_bikes[1].regex_pat"), parser.createJsonValue("\"(?i)al\""));
            })
            .thenCompose(r -> {
                System.out.println(r); // >>> OK
                // REMOVE_START
                ...
                return asyncCommands.jsonSet("bikes:inventory", JsonPath.of("$.inventory.mountain_bikes[2].regex_pat"), parser.createJsonValue("\"(?i)al\""));
            })
            .thenCompose(res22 -> {
                ...
                return asyncCommands.jsonGet("bikes:inventory", JsonPath.of("$.inventory.mountain_bikes[?(@.specs.material =~ @.regex_pat)].model"));
            })
            // REMOVE_START
            .thenApply(r -> {
            ...
            CompletableFuture<Void> updateFilters1 = asyncCommands.jsonSet("bikes:inventory", JsonPath.of("$.inventory.*[?(@.price<2000)].price"), parser.createJsonValue("1500"))
            .thenCompose(r -> {
                System.out.println(r); // >>> OK
                // REMOVE_START
                assertThat(r).isEqualTo("OK");
            ...
            CompletableFuture<Void> updateFilters2 = asyncCommands.jsonArrappend("bikes:inventory", JsonPath.of("$.inventory.*[?(@.price<2000)].colors"), parser.createJsonValue("\"pink\""))
            .thenCompose(r -> {
