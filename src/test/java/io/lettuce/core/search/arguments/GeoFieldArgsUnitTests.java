 ...
 */
@Tag(UNIT_TEST)
class GeoFieldArgsUnitTests {

    @Test
    void testDefaultGeoFieldArgs() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("location").build();
    ...
    void testGeoFieldArgsWithAlias() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("coordinates").as("location").build();
    ...
    void testGeoFieldArgsWithSortable() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("position").sortable().build();
    ...
    void testGeoFieldArgsWithSortableAndUnnormalized() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("geo_point").sortable().unNormalizedForm().build();
    ...
    void testGeoFieldArgsWithNoIndex() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("internal_location").noIndex().build();
    ...
    void testGeoFieldArgsWithIndexEmpty() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("optional_location").indexEmpty().build();
    ...
    void testGeoFieldArgsWithIndexMissing() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("nullable_location").indexMissing().build();
    ...
    void testGeoFieldArgsWithAllOptions() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("comprehensive_geo").as("geo").sortable().unNormalizedForm().noIndex()
    ...
    void testGeoFieldArgsBuild() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("store_location").as("location").sortable().unNormalizedForm()
                .indexEmpty().indexMissing().build();
    ...
    void testGeoFieldArgsMinimalBuild() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("simple_geo").build();
    ...
    void testGeoFieldArgsSortableWithoutUnnormalized() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("sortable_geo").sortable().build();
    ...
    void testGeoFieldArgsWithNoIndexOnly() {
        GeoFieldArgs field = GeoFieldArgs.builder().name("no_index_geo").noIndex().build();
    ...
    void testBuilderMethodChaining() {
        ...
        GeoFieldArgs field = GeoFieldArgs.builder().name("chained_geo").as("chained_alias").sortable().unNormalizedForm()
    ...
    void testGeoFieldArgsTypeSpecificBehavior() {
        ...
        GeoFieldArgs field = GeoFieldArgs.builder().name("geo_field").build();
    ...
    void testGeoFieldArgsInheritedMethods() {
        ...
        GeoFieldArgs field = GeoFieldArgs.builder().name("inherited_geo").noIndex().indexEmpty().indexMissing().build();
