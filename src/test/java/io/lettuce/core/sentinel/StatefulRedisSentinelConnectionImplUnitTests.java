...
class StatefulRedisSentinelConnectionImplUnitTests {
    ...
    void reactiveCommandsAreCached() {
        RedisSentinelReactiveCommands<String, String> first = RedisReactiveCommands.from(connection);
        RedisSentinelReactiveCommands<String, String> second = RedisReactiveCommands.from(connection);
