...
class StatefulRedisClusterConnectionImplUnitTests {
    ...
    void reactiveCommandsAreCached() {
        RedisAdvancedClusterReactiveCommands<String, String> first = RedisReactiveCommands.from(connection);
        RedisAdvancedClusterReactiveCommands<String, String> second = RedisReactiveCommands.from(connection);
