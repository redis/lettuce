...
class CircuitBreakerUnitTests {
    ...
    class MetricsEvaluationTests {
        ...
        void shouldOpenWithSingleFailureWhenMinimumFailuresIsZero() {
            ...
            CircuitBreakerConfig config = getTestConfig(100.0f, 0);
            try (CircuitBreaker circuitBreaker = new CircuitBreakerImpl(config)) {
        ...
        void shouldConsiderOnlyCountWhenFailureRateThresholdIsZero() {
            ...
            CircuitBreakerConfig config = getTestConfig(0.0f, 5);
            try (CircuitBreaker circuitBreaker = new CircuitBreakerImpl(config)) {
        ...
        void shouldRequireBothConditionsWhenBothThresholdsAreNonZero() {
            ...
            CircuitBreakerConfig config = getTestConfig(50.0f, 10);
            try (CircuitBreaker circuitBreaker = new CircuitBreakerImpl(config)) {
    ...
    class BasicFunctionalityTests {
        ...
        @BeforeEach
        void setUp() {
            CircuitBreakerConfig config = getTestConfig(50.0f, 5);
    ...
    class ExceptionTrackingTests {
        ...
        void shouldSupportCustomTrackedException() {
            ...
            CircuitBreakerConfig config = CircuitBreakerConfig.builder().failureRateThreshold(50.0f).minimumNumberOfFailures(5)
                    .trackedExceptions(customExceptions).build();
    ...
    class ConfigurationTests {
        ...
        void shouldUseDefaultConfiguration() {
            CircuitBreakerConfig config = CircuitBreakerConfig.DEFAULT;
        ...
        void shouldAcceptCustomConfiguration() {
            ...
            CircuitBreakerConfig config = CircuitBreakerConfig.builder().failureRateThreshold(25.5f)
        ...
        void shouldSupportZeroFailureRateThreshold() {
            CircuitBreakerConfig config = getTestConfig(0.0f, 10);
        ...
        void shouldSupportHighFailureRateThreshold() {
            CircuitBreakerConfig config = getTestConfig(99.9f, 5);
    ...
    class EdgeCaseTests {
        ...
        void shouldHandleLargeNumberOfOperations() {
            CircuitBreakerConfig config = getTestConfig(0.99f, 1000);
            try (CircuitBreaker circuitBreaker = new CircuitBreakerImpl(config)) {
