...
public class SentinelRule implements TestRule {
    ...
    private Map<Integer, RedisSentinelCommands<String, String>> sentinelConnections = LettuceMaps.newHashMap();
    ...
    public boolean hasMaster(int... redisPorts) {
        ...
        Map<Integer, RedisCommands<String, String>> connections = LettuceMaps.newHashMap();
