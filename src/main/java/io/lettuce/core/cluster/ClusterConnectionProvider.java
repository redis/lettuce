...
interface ClusterConnectionProvider extends Closeable {
     ...
     *
     * @param intent {@link io.lettuce.core.cluster.ClusterConnectionProvider.Intent#READ} or
     *        {@link io.lettuce.core.cluster.ClusterConnectionProvider.Intent#WRITE} {@literal READ} connections will be
