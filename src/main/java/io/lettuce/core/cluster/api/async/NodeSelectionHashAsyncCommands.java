...
public interface NodeSelectionHashAsyncCommands<K, V> {
     ...
     * @since 6.1
     */
    AsyncExecutions<K> hrandfield(K key);
     ...
     * @since 6.1
     */
    AsyncExecutions<List<K>> hrandfield(K key, long count);
     ...
     * @since 6.1
     */
    AsyncExecutions<KeyValue<K, V>> hrandfieldWithvalues(K key);
     ...
     * @since 6.1
     */
    AsyncExecutions<List<KeyValue<K, V>>> hrandfieldWithvalues(K key, long count);
     ...
     */
    @Experimental
    AsyncExecutions<String> himportSet(K key, HashImport<K> fieldset, V... values);
