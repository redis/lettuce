...
public interface NodeSelectionHashAsyncCommands<K, V> {
     ...
     * @since 7.7
     */
    AsyncExecutions<String> himportPrepare(K fieldsetName, K field);
     ...
     * @since 7.7
     */
    AsyncExecutions<String> himportPrepare(K fieldsetName, K... fields);
     ...
     * @since 7.7
     */
    AsyncExecutions<String> himportSet(K key, K fieldsetName, V value);
     ...
     * @since 7.7
     */
    AsyncExecutions<String> himportSet(K key, K fieldsetName, V... values);
     ...
     * @since 7.7
     */
    AsyncExecutions<Boolean> himportDiscard(K fieldsetName);
