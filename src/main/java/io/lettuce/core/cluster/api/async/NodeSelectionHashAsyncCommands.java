...
public interface NodeSelectionHashAsyncCommands<K, V> {
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpire(K key, long milliseconds, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpire(K key, long milliseconds, ExpireArgs expireArgs, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpire(K key, Duration milliseconds, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpire(K key, Duration milliseconds, ExpireArgs expireArgs, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpireat(K key, long timestamp, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpireat(K key, long timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpireat(K key, Date timestamp, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpireat(K key, Date timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpireat(K key, Instant timestamp, K... fields);
     ...
     * @since 7.0
     */
    AsyncExecutions<Boolean> hpexpireat(K key, Instant timestamp, ExpireArgs expireArgs, K... fields);
