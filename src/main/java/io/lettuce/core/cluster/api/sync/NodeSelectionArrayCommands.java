...
public interface NodeSelectionArrayCommands<K, V> {
     ...
     */
    @Experimental
    Executions<List<V>> argetrange(K key, Range<Long> range);
     ...
     */
    @Experimental
    Executions<List<V>> arlastitemsRev(K key, long count);
     ...
     */
    @Experimental
    Executions<List<IndexedValue<V>>> arscan(K key, ArScanArgs scanArgs);
     ...
     */
    @Experimental
    Executions<V> aropAggregate(K key, Range<Long> range, ArAggregateType operation);
     ...
     */
    @Experimental
    Executions<Long> aropCount(K key, Range<Long> range, ArCountType operation);
     ...
     */
    @Experimental
    Executions<Long> aropMatch(K key, Range<Long> range, V matchValue);
     ...
     */
    @Experimental
    Executions<ArrayMetadata> arinfo(K key);
     ...
     */
    @Experimental
    Executions<ArrayFullMetadata> arinfoFull(K key);
