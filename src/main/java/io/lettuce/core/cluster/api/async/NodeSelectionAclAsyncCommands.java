...
public interface NodeSelectionAclAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<List<AclCategory>> aclCat();
     ...
     */
    AsyncExecutions<List<CommandType>> aclCat(AclCategory category);
     ...
     */
    AsyncExecutions<Map<String, Object>> aclGetuser(String username);
