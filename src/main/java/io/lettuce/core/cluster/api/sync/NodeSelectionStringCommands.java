...
public interface NodeSelectionStringCommands<K, V> {
     ...
     */
    Executions<String> set(K key, V value, ValueCondition<V> condition);
     ...
     * @return String simple-string-reply {@code OK} if {@code SET} was executed; {@code null} if the operation was aborted.
     */
    Executions<String> set(K key, V value, SetArgs setArgs, ValueCondition<V> condition);
     ...
     */
    Executions<V> setGet(K key, V value, ValueCondition<V> condition);
     ...
     * @return V bulk-string-reply the previous value if the key existed, or {@code null} when {@code key} did not exist.
     */
    Executions<V> setGet(K key, V value, SetArgs setArgs, ValueCondition<V> condition);
