...
public interface NodeSelectionTimeSeriesAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<List<Long>> tsMAdd(Map.Entry<K, TsSample>... entries);
     ...
     */
    AsyncExecutions<List<Long>> tsMAdd(Map.Entry<K, TsSample> entry);
     ...
     */
    AsyncExecutions<List<TsMGetValue<K>>> tsMGet(V... filters);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    AsyncExecutions<List<TsMGetValue<K>>> tsMGet(V filter);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    AsyncExecutions<List<TsMGetValue<K>>> tsMGet(TsMGetArgs mGetArgs, V... filters);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    AsyncExecutions<List<TsMGetValue<K>>> tsMGet(TsMGetArgs mGetArgs, V filter);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    AsyncExecutions<List<K>> tsQueryIndex(V... filters);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    AsyncExecutions<List<K>> tsQueryIndex(V filter);
