...
public interface RediSearchAsyncCommands<K, V> {
     ...
     */
    @Experimental
    AsyncExecutions<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query);
     ...
     */
    @Experimental
    AsyncExecutions<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query, SearchArgs<K, V> searchArgs);
