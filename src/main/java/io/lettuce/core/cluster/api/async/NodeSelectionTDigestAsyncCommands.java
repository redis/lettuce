...
public interface NodeSelectionTDigestAsyncCommands<K, V> {
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestAdd(K key, double... values);
     ...
     */
    AsyncExecutions<List<Double>> tdigestCDF(K key, double value);
     ...
     */
    AsyncExecutions<List<Double>> tdigestCDF(K key, double... values);
     ...
     */
    AsyncExecutions<List<Long>> tdigestRank(K key, double value);
     ...
     */
    AsyncExecutions<List<Long>> tdigestRank(K key, double... values);
     ...
     */
    AsyncExecutions<List<Long>> tdigestRevRank(K key, double value);
     ...
     */
    AsyncExecutions<List<Long>> tdigestRevRank(K key, double... values);
