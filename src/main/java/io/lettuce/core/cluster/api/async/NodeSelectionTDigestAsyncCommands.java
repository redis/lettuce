...
public interface NodeSelectionTDigestAsyncCommands<K, V> {
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, K sourceKey, TDigestMergeArgs mergeArgs);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, TDigestMergeArgs mergeArgs, K... sourceKeys);
