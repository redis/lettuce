...
/**
 * Asynchronous executed commands on a node selection for T-Digest sketch.
 *
 ...
 * @since 7.7
 */
public interface NodeSelectionTDigestAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<String> tdigestAdd(K key, V value);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestAdd(K key, V... values);
     ...
     */
    AsyncExecutions<List<Double>> tdigestByRank(K key, long rank);
     ...
     */
    AsyncExecutions<List<Double>> tdigestByRank(K key, long... ranks);
     ...
     */
    AsyncExecutions<List<Double>> tdigestByRevRank(K key, long reverseRank);
     ...
     */
    AsyncExecutions<List<Double>> tdigestByRevRank(K key, long... reverseRanks);
     ...
     */
    AsyncExecutions<List<Double>> tdigestCDF(K key, V value);
     ...
     */
    AsyncExecutions<List<Double>> tdigestCDF(K key, V... values);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestCreate(K key);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestCreate(K key, long compression);
     ...
     */
    AsyncExecutions<TDigestInfoValue> tdigestInfo(K key);
     ...
     */
    AsyncExecutions<Double> tdigestMax(K key);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, K sourceKey);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, K sourceKey, boolean override);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, K sourceKey, long compression);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, K sourceKey, long compression, boolean override);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, K... sourceKeys);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, boolean override, K... sourceKeys);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, long compression, K... sourceKeys);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestMerge(K destination, long compression, boolean override, K... sourceKeys);
     ...
     */
    AsyncExecutions<Double> tdigestMin(K key);
     ...
     *         sketch is empty.
     */
    AsyncExecutions<List<Double>> tdigestQuantile(K key, double quantile);
     ...
     *         the sketch is empty.
     */
    AsyncExecutions<List<Double>> tdigestQuantile(K key, double... quantiles);
     ...
     *         maximum.
     */
    AsyncExecutions<List<Long>> tdigestRank(K key, V value);
     ...
     */
    AsyncExecutions<List<Long>> tdigestRank(K key, V... values);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    AsyncExecutions<String> tdigestReset(K key);
     ...
     */
    AsyncExecutions<List<Long>> tdigestRevRank(K key, V value);
     ...
     *         minimum.
     */
    AsyncExecutions<List<Long>> tdigestRevRank(K key, V... values);
     ...
     */
    AsyncExecutions<Double> tdigestTrimmedMean(K key, double lowCutQuantile, double highCutQuantile);
