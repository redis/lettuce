...
public interface NodeSelectionCommands<K, V> extends BaseNodeSelectionCommands<K, V>, NodeSelectionFunctionCommands<K, V>,
        ...
        NodeSelectionVectorSetCommands<K, V>, NodeSelectionSearchCommands<K>, NodeSelectionBloomFilterCommands<K, V>,
        NodeSelectionCuckooFilterCommands<K, V>, NodeSelectionTopKCommands<K, V>, NodeSelectionTimeSeriesCommands<K, V>,
        NodeSelectionCMSCommands<K, V>, NodeSelectionTDigestCommands<K, V> {
}
