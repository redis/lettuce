...
public interface NodeSelectionCommands<K, V>
        extends BaseNodeSelectionCommands<K, V>, NodeSelectionFunctionCommands<K, V>, NodeSelectionGeoCommands<K, V>,
        ...
        NodeSelectionSearchCommands<K>, NodeSelectionBloomFilterCommands<K, V>, NodeSelectionCuckooFilterCommands<K, V>,
        NodeSelectionTopKCommands<K, V>, NodeSelectionCMSCommands<K, V>, NodeSelectionTDigestCommands<K, V> {
}
