...
public interface NodeSelectionSearchCommands<K, V> {
     ...
     */
    @Experimental
    Executions<AggregationReply<K, V>> ftCursorread(K index, Cursor cursor, int count);
     ...
     */
    @Experimental
    Executions<AggregationReply<K, V>> ftCursorread(K index, Cursor cursor);
     ...
     */
    @Experimental
    Executions<String> ftCursordel(K index, Cursor cursor);
