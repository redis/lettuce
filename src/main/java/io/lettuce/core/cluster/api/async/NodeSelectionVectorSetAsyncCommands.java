...
public interface NodeSelectionVectorSetAsyncCommands<K, V> {
     ...
     */
    @Experimental
    AsyncExecutions<Boolean> vismember(K key, V element);
     ...
     */
    @Experimental
    AsyncExecutions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, Double... vectors);
     ...
     */
    @Experimental
    AsyncExecutions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, V element);
     ...
     */
    @Experimental
    AsyncExecutions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    AsyncExecutions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, VSimArgs args, V element);
