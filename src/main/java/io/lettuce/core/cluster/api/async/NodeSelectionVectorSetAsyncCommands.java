...
public interface NodeSelectionVectorSetAsyncCommands<K, V> {
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> vdim(K key);
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> vlinksWithScores(K key, V element);
     ...
     */
    @Experimental
    AsyncExecutions<Map<V, Long>> vsimWithScore(K key, Double... vectors);
     ...
     */
    @Experimental
    AsyncExecutions<Map<V, Long>> vsimWithScore(K key, V element);
     ...
     */
    @Experimental
    AsyncExecutions<Map<V, Long>> vsimWithScore(K key, VSimArgs args, Double... vectors);
