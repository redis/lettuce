...
/**
 * Synchronous executed commands on a node selection for RedisTimeSeries.
 *
 * @author Gyumin Hwang
 * @param <K> Key type.
 * @param <V> Value type.
 ...
 * @since 7.8
 */
public interface NodeSelectionTimeSeriesCommands<K, V> {
     ...
     */
    Executions<String> tsCreate(K key);
     ...
     * @return String simple-string-reply {@code OK} if {@code TS.CREATE} was executed correctly.
     */
    Executions<String> tsCreate(K key, TsCreateArgs createArgs);
     ...
     */
    Executions<String> tsAlter(K key);
     ...
     * @return String simple-string-reply {@code OK} if {@code TS.ALTER} was executed correctly.
     */
    Executions<String> tsAlter(K key, TsAlterArgs alterArgs);
     ...
     */
    Executions<String> tsCreateRule(K sourceKey, K destKey, TsAggregationType aggregationType, long bucketDuration);
     ...
     */
    Executions<String> tsDeleteRule(K sourceKey, K destKey);
     ...
     */
    Executions<Long> tsDel(K key, long fromTimestamp, long toTimestamp);
     ...
     */
    Executions<Long> tsAdd(K key, long timestamp, double value);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    Executions<Long> tsAdd(K key, long timestamp, double value, TsAddArgs addArgs);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    Executions<Long> tsAdd(K key, double value);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    Executions<Long> tsAdd(K key, double value, TsAddArgs addArgs);
     ...
     */
    Executions<List<Long>> tsMAdd(Map.Entry<K, TsSample>... entries);
     ...
     */
    Executions<List<Long>> tsMAdd(Map.Entry<K, TsSample> entry);
     ...
     */
    Executions<Long> tsIncrBy(K key, double value);
     ...
     * @return Long integer-reply the timestamp of the updated sample.
     */
    Executions<Long> tsIncrBy(K key, double value, TsIncrByArgs incrByArgs);
     ...
     * @return Long integer-reply the timestamp of the updated sample.
     */
    Executions<Long> tsDecrBy(K key, double value);
     ...
     * @return Long integer-reply the timestamp of the updated sample.
     */
    Executions<Long> tsDecrBy(K key, double value, TsIncrByArgs decrByArgs);
     ...
     */
    Executions<TsSample> tsGet(K key);
     ...
     * @return TsSample the last sample of the time series, or {@code null} if the series has no samples.
     */
    Executions<TsSample> tsGet(K key, boolean latest);
     ...
     */
    Executions<TsInfoValue<K>> tsInfo(K key);
     ...
     *         {@code true}.
     */
    Executions<TsInfoValue<K>> tsInfo(K key, boolean debug);
