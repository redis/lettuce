 ...
 * @since 7.7
 */
public interface NodeSelectionBloomFilterAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<Boolean> bfAdd(K key, V value);
     ...
     */
    AsyncExecutions<Long> bfCard(K key);
     ...
     */
    AsyncExecutions<Boolean> bfExists(K key, V value);
     ...
     */
    AsyncExecutions<BfInfoValue> bfInfo(K key);
     ...
     *         and nonscaling.
     */
    AsyncExecutions<List<Boolean>> bfInsert(K key, V value);
     ...
     *         and nonscaling.
     */
    AsyncExecutions<List<Boolean>> bfInsert(K key, BfInsertArgs insertArgs, V value);
     ...
     *         and nonscaling.
     */
    AsyncExecutions<List<Boolean>> bfInsert(K key, V... values);
     ...
     *         and nonscaling.
     */
    AsyncExecutions<List<Boolean>> bfInsert(K key, BfInsertArgs insertArgs, V... values);
     ...
     */
    AsyncExecutions<String> bfLoadChunk(K key, long iterator, byte[] data);
     ...
     *         and nonscaling.
     */
    AsyncExecutions<List<Boolean>> bfMAdd(K key, V... values);
     ...
     *         filter.
     */
    AsyncExecutions<List<Boolean>> bfMExists(K key, V... values);
     ...
     */
    AsyncExecutions<String> bfReserve(K key, double errorRate, long capacity);
     ...
     * @return String simple-string-reply {@code OK} if {@code BF.RESERVE} was executed correctly.
     */
    AsyncExecutions<String> bfReserve(K key, double errorRate, long capacity, BfReserveArgs reserveArgs);
