...
public interface NodeSelectionSearchAsyncCommands<K, V> {
     ...
     */
    @Experimental
    AsyncExecutions<AggregationReply<K, V>> ftCursorread(K index, Cursor cursor, int count);
     ...
     */
    @Experimental
    AsyncExecutions<AggregationReply<K, V>> ftCursorread(K index, Cursor cursor);
     ...
     */
    @Experimental
    AsyncExecutions<String> ftCursordel(K index, Cursor cursor);
