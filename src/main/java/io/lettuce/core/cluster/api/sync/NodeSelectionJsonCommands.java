...
/**
 * Synchronous executed commands on a node selection for JSON documents
 *
 * @param <K> Key type.
 * @param <V> Value type.
...
public interface NodeSelectionJsonCommands<K, V> {
     ...
     * @since 6.8
     */
    Executions<List<Long>> jsonArrappend(K key, String... jsonStrings);
     ...
     * @since 6.8
     */
    Executions<List<Long>> jsonArrappend(K key, JsonPath jsonPath, String... jsonStrings);
     ...
     * @since 6.8
     */
    Executions<List<Long>> jsonArrindex(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.8
     */
    Executions<List<Long>> jsonArrindex(K key, JsonPath jsonPath, String jsonString, JsonRangeArgs range);
     ...
     * @since 6.8
     */
    Executions<List<Long>> jsonArrinsert(K key, JsonPath jsonPath, int index, String... jsonStrings);
     ...
     * @since 6.5
     */
    Executions<List<Long>> jsonArrtrim(K key, JsonPath jsonPath, JsonRangeArgs range);
     ...
     * @since 6.8
     */
    Executions<String> jsonMerge(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.8
     */
    Executions<String> jsonSet(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.8
     */
    Executions<String> jsonSet(K key, JsonPath jsonPath, String jsonString, JsonSetArgs options);
     ...
     * @since 6.8
     */
    Executions<List<Long>> jsonStrappend(K key, String jsonString);
     ...
     * @since 6.8
     */
    Executions<List<Long>> jsonStrappend(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.5
     */
    Executions<List<Long>> jsonToggle(K key, JsonPath jsonPath);
