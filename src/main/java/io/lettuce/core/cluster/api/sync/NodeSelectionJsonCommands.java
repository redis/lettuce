...
public interface NodeSelectionJsonCommands<K, V> {
     ...
     */
    Executions<Boolean> jsonMerge(K key, JsonPath jsonPath, JsonValue<V> value);
     ...
     * @since 6.5
     */
    Executions<Boolean> jsonSet(K key, JsonPath jsonPath, JsonValue<V> value, JsonSetArgs options);
