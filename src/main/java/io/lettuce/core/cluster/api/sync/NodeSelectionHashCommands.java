...
public interface NodeSelectionHashCommands<K, V> {
     ...
     * @since 7.7
     */
    Executions<String> himportPrepare(K fieldsetName, K field);
     ...
     * @since 7.7
     */
    Executions<String> himportPrepare(K fieldsetName, K... fields);
     ...
     * @since 7.7
     */
    Executions<String> himportSet(K key, K fieldsetName, V value);
     ...
     * @since 7.7
     */
    Executions<String> himportSet(K key, K fieldsetName, V... values);
     ...
     * @since 7.7
     */
    Executions<Boolean> himportDiscard(K fieldsetName);
