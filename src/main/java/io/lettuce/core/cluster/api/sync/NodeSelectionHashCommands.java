...
public interface NodeSelectionHashCommands<K, V> {
     ...
     * @since 6.4
     */
    Executions<KeyScanCursor<K>> hscanNovalues(K key);
     ...
     * @since 6.4
     */
    Executions<KeyScanCursor<K>> hscanNovalues(K key, ScanArgs scanArgs);
     ...
     * @since 6.4
     */
    Executions<KeyScanCursor<K>> hscanNovalues(K key, ScanCursor scanCursor, ScanArgs scanArgs);
     ...
     * @since 6.4
     */
    Executions<KeyScanCursor<K>> hscanNovalues(K key, ScanCursor scanCursor);
     ...
     * @since 6.4
     */
    Executions<StreamScanCursor> hscanNovalues(KeyStreamingChannel<K> channel, K key);
     ...
     * @since 6.4
     */
    Executions<StreamScanCursor> hscanNovalues(KeyStreamingChannel<K> channel, K key, ScanArgs scanArgs);
     ...
     * @since 6.4
     */
    Executions<StreamScanCursor> hscanNovalues(KeyStreamingChannel<K> channel, K key, ScanCursor scanCursor, ScanArgs scanArgs);
     ...
     * @since 6.4
     */
    Executions<StreamScanCursor> hscanNovalues(KeyStreamingChannel<K> channel, K key, ScanCursor scanCursor);
     ...
     * @since 6.6
     */
    Executions<Long> hsetex(K key, Map<K, V> map);
     ...
     * @since 6.6
     */
    Executions<Long> hsetex(K key, HSetExArgs hSetExArgs, Map<K, V> map);
     ...
     * @since 6.6
     */
    Executions<List<KeyValue<K, V>>> hgetex(K key, K... fields);
     ...
     * @since 6.6
     */
    Executions<List<KeyValue<K, V>>> hgetex(K key, HGetExArgs hGetExArgs, K... fields);
     ...
     * @return List&lt;KeyValue&lt;K, V&gt;&gt; array-reply list of fields and their values.
     */
    Executions<List<KeyValue<K, V>>> hgetdel(K key, K... fields);
     ...
     * @return Long the number of fields that were removed from the hash.
     */
    Executions<Long> hgetdel(KeyValueStreamingChannel<K, V> channel, K key, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpire(K key, long seconds, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpire(K key, long seconds, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpire(K key, Duration seconds, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpire(K key, Duration seconds, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpireat(K key, long timestamp, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpireat(K key, long timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpireat(K key, Date timestamp, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpireat(K key, Date timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpireat(K key, Instant timestamp, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpireat(K key, Instant timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hexpiretime(K key, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpire(K key, long milliseconds, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpire(K key, long milliseconds, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpire(K key, Duration milliseconds, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpire(K key, Duration milliseconds, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpireat(K key, long timestamp, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpireat(K key, long timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpireat(K key, Date timestamp, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpireat(K key, Date timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpireat(K key, Instant timestamp, K... fields);
     ...
     * @since 6.4
     */
    Executions<List<Long>> hpexpireat(K key, Instant timestamp, ExpireArgs expireArgs, K... fields);
     ...
     * <p>
     * Not supported inside a {@code MULTI} transaction.
     *
     ...
     * @throws IllegalArgumentException if {@code key}, {@code fieldset}, or {@code values} is {@code null}, or if the number of
     *         {@code values} does not match {@link HashImport#size()}.
