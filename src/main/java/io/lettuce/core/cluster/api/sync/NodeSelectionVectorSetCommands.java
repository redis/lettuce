...
public interface NodeSelectionVectorSetCommands<K, V> {
     ...
     */
    @Experimental
    Executions<List<V>> vlinksWithScores(K key, V element);
     ...
     */
    @Experimental
    Executions<Map<V, Long>> vsimWithScore(K key, Double... vectors);
     ...
     */
    @Experimental
    Executions<Map<V, Long>> vsimWithScore(K key, V element);
     ...
     */
    @Experimental
    Executions<Map<V, Long>> vsimWithScore(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    Executions<Map<V, Long>> vsimWithScore(K key, VSimArgs args, V element);
}
