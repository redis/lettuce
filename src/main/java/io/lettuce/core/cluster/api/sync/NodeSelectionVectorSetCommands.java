...
/**
 * Synchronous executed commands on a node selection for Vector Sets
 * <p>
...
public interface NodeSelectionVectorSetCommands<K, V> {
     ...
     */
    @Experimental
    Executions<Boolean> vadd(K key, V element, Double... vectors);
     ...
     */
    @Experimental
    Executions<Boolean> vadd(K key, int dimensionality, V element, Double... vectors);
     ...
     */
    @Experimental
    Executions<Boolean> vadd(K key, V element, VAddArgs args, Double... vectors);
     ...
     */
    @Experimental
    Executions<Boolean> vadd(K key, int dimensionality, V element, VAddArgs args, Double... vectors);
     ...
     */
    @Experimental
    Executions<Boolean> vismember(K key, V element);
     ...
     */
    @Experimental
    Executions<Boolean> vClearAttributes(K key, V element);
     ...
     */
    @Experimental
    Executions<List<Double>> vemb(K key, V element);
     ...
     */
    @Experimental
    Executions<RawVector> vembRaw(K key, V element);
     ...
     */
    @Experimental
    Executions<String> vgetattr(K key, V element);
     ...
     */
    @Experimental
    Executions<List<JsonValue>> vgetattrAsJsonValue(K key, V element);
     ...
     */
    @Experimental
    Executions<VectorMetadata> vinfo(K key);
     ...
     */
    @Experimental
    Executions<V> vrandmember(K key);
     ...
     */
    @Experimental
    Executions<List<V>> vrandmember(K key, int count);
     ...
     */
    @Experimental
    Executions<Boolean> vrem(K key, V element);
     ...
     */
    @Experimental
    Executions<Boolean> vsetattr(K key, V element, String json);
     ...
     */
    @Experimental
    Executions<Boolean> vsetattr(K key, V element, JsonValue json);
     ...
     */
    @Experimental
    Executions<List<V>> vsim(K key, Double... vectors);
     ...
     */
    @Experimental
    Executions<List<V>> vsim(K key, V element);
     ...
     */
    @Experimental
    Executions<List<V>> vsim(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    Executions<List<V>> vsim(K key, VSimArgs args, V element);
     ...
     */
    @Experimental
    Executions<Map<V, Double>> vsimWithScore(K key, Double... vectors);
     ...
     */
    @Experimental
    Executions<Map<V, Double>> vsimWithScore(K key, V element);
     ...
     */
    @Experimental
    Executions<Map<V, Double>> vsimWithScore(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    Executions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, Double... vectors);
     ...
     */
    @Experimental
    Executions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, V element);
     ...
     */
    @Experimental
    Executions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    Executions<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, VSimArgs args, V element);
