...
public interface NodeSelectionJsonAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<String> jsonMerge(K key, JsonPath jsonPath, JsonValue<V> value);
     ...
     * @since 6.5
     */
    AsyncExecutions<String> jsonSet(K key, JsonPath jsonPath, JsonValue<V> value, JsonSetArgs options);
