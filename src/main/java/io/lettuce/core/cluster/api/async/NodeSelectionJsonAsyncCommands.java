...
public interface NodeSelectionJsonAsyncCommands<K, V> {
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrappend(K key, JsonPath jsonPath, JsonElement... elements);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrindex(K key, JsonPath jsonPath, JsonElement element, JsonRangeArgs range);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrinsert(K key, JsonPath jsonPath, int index, JsonElement... elements);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<JsonElement>> jsonArrpop(K key, JsonPath jsonPath, int index);
     ...
     * @since 6.5
     */
    AsyncExecutions<JsonElement> jsonGet(K key, JsonGetArgs options, JsonPath... jsonPaths);
     ...
     */
    AsyncExecutions<Boolean> jsonMerge(K key, JsonPath jsonPath, JsonElement element);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<JsonElement>> jsonMGet(JsonPath jsonPath, K... keys);
     ...
     * @since 6.5
     */
    AsyncExecutions<Boolean> jsonMSet(JsonMsetArgs... arguments);
     ...
     * @since 6.5
     */
    AsyncExecutions<JsonElement> jsonNumincrby(K key, JsonPath jsonPath, Number number);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<List<V>>> jsonObjkeys(K key, JsonPath jsonPath);
     ...
     * @since 6.5
     */
    AsyncExecutions<Boolean> jsonSet(K key, JsonPath jsonPath, JsonElement element, JsonSetArgs options);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonStrappend(K key, JsonPath jsonPath, JsonElement element);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Boolean>> jsonToggle(K key, JsonPath jsonPath);
