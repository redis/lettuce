...
/**
 * Asynchronous executed commands on a node selection for JSON documents
 *
 * @param <K> Key type.
 * @param <V> Value type.
...
public interface NodeSelectionJsonAsyncCommands<K, V> {
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrappend(K key, JsonValue... values);
     ...
     * @since 6.8
     */
    AsyncExecutions<List<Long>> jsonArrappend(K key, String... jsonStrings);
     ...
     * @since 6.8
     */
    AsyncExecutions<List<Long>> jsonArrappend(K key, JsonPath jsonPath, String... jsonStrings);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrindex(K key, JsonPath jsonPath, JsonValue value, JsonRangeArgs range);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrindex(K key, JsonPath jsonPath, JsonValue value);
     ...
     * @since 6.8
     */
    AsyncExecutions<List<Long>> jsonArrindex(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.8
     */
    AsyncExecutions<List<Long>> jsonArrindex(K key, JsonPath jsonPath, String jsonString, JsonRangeArgs range);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrinsert(K key, JsonPath jsonPath, int index, JsonValue... values);
     ...
     * @since 6.8
     */
    AsyncExecutions<List<Long>> jsonArrinsert(K key, JsonPath jsonPath, int index, String... jsonStrings);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrlen(K key, JsonPath jsonPath);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrlen(K key);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<JsonValue>> jsonArrpop(K key, JsonPath jsonPath, int index);
     ...
     * @since 7.0
     */
    AsyncExecutions<List<String>> jsonArrpopRaw(K key, JsonPath jsonPath, int index);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<JsonValue>> jsonArrpop(K key, JsonPath jsonPath);
     ...
     * @since 7.0
     */
    AsyncExecutions<List<String>> jsonArrpopRaw(K key, JsonPath jsonPath);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<JsonValue>> jsonArrpop(K key);
     ...
     * @since 7.0
     */
    AsyncExecutions<List<String>> jsonArrpopRaw(K key);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonArrtrim(K key, JsonPath jsonPath, JsonRangeArgs range);
     ...
     * @since 6.5
     */
    AsyncExecutions<Long> jsonClear(K key, JsonPath jsonPath);
     ...
     * @since 6.5
     */
    AsyncExecutions<Long> jsonClear(K key);
     ...
     * @since 6.5
     */
    AsyncExecutions<Long> jsonDel(K key, JsonPath jsonPath);
     ...
     * @since 6.8
     */
    AsyncExecutions<String> jsonMerge(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<JsonValue>> jsonMGet(JsonPath jsonPath, K... keys);
     ...
     * @since 7.0
     */
    AsyncExecutions<List<String>> jsonMGetRaw(JsonPath jsonPath, K... keys);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Number>> jsonNumincrby(K key, JsonPath jsonPath, Number number);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<V>> jsonObjkeys(K key);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonObjlen(K key, JsonPath jsonPath);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonObjlen(K key);
     ...
     * @since 6.5
     */
    AsyncExecutions<String> jsonSet(K key, JsonPath jsonPath, JsonValue value, JsonSetArgs options);
     ...
     * @since 6.5
     */
    AsyncExecutions<String> jsonSet(K key, JsonPath jsonPath, JsonValue value);
     ...
     * @since 6.8
     */
    AsyncExecutions<String> jsonSet(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.8
     */
    AsyncExecutions<String> jsonSet(K key, JsonPath jsonPath, String jsonString, JsonSetArgs options);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonStrappend(K key, JsonPath jsonPath, JsonValue value);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonStrappend(K key, JsonValue value);
     ...
     * @since 6.8
     */
    AsyncExecutions<List<Long>> jsonStrappend(K key, String jsonString);
     ...
     * @since 6.8
     */
    AsyncExecutions<List<Long>> jsonStrappend(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonStrlen(K key, JsonPath jsonPath);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonStrlen(K key);
     ...
     * @since 6.5
     */
    AsyncExecutions<List<Long>> jsonToggle(K key, JsonPath jsonPath);
