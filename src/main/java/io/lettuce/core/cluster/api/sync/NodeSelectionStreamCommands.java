...
public interface NodeSelectionStreamCommands<K, V> {
     ...
     * @since 6.8
     */
    Executions<List<StreamEntryDeletionResult>> xackdel(K key, K group, String... messageIds);
     ...
     * @since 7.3
     */
    Executions<String> xcfgset(K key, XCfgSetArgs args);
     ...
     * @since 6.8
     */
    Executions<List<StreamEntryDeletionResult>> xdelex(K key, String... messageIds);
     ...
     * @since 6.8
     */
    Executions<List<StreamEntryDeletionResult>> xdelex(K key, StreamDeletionPolicy policy, String... messageIds);
     ...
     * @since 5.2
     */
    Executions<List<Object>> xinfoStream(K key);
     ...
     * @since 5.2
     */
    Executions<List<Object>> xinfoGroups(K key);
     ...
     * @since 5.2
     */
    Executions<List<Object>> xinfoConsumers(K key, K group);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    Executions<List<StreamMessage<K, V>>> xreadgroup(Consumer<K> consumer, StreamOffset<K>... streams);
