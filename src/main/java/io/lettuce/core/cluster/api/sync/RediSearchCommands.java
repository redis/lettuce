...
public interface RediSearchCommands<K, V> {
     ...
     */
    @Experimental
    Executions<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query);
     ...
     */
    @Experimental
    Executions<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query, SearchArgs<K, V> searchArgs);
     ...
     */
    @Experimental
    Executions<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query, AggregateArgs<K, V> aggregateArgs);
