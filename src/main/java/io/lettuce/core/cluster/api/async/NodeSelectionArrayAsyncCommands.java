...
/**
 * Asynchronous executed commands on a node selection for the Redis Array data type.
 * <p>
 ...
 * @since 7.6
 */
public interface NodeSelectionArrayAsyncCommands<K, V> {
     ...
     */
    @Experimental
    AsyncExecutions<Long> arset(K key, long index, V value);
    ...
    AsyncExecutions<Long> arset(K key, long index, V... values);
     ...
     */
    @Experimental
    AsyncExecutions<Long> armset(K key, Map<Long, V> indexValueMap);
     ...
     */
    @Experimental
    AsyncExecutions<V> arget(K key, long index);
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> armget(K key, long... indices);
     ...
     */
    @Experimental
    AsyncExecutions<Long> ardel(K key, long index);
     ...
     */
    @Experimental
    AsyncExecutions<Long> ardel(K key, long... indices);
     ...
     */
    @Experimental
    AsyncExecutions<Long> ardelrange(K key, long start, long end);
     ...
     */
    @Experimental
    AsyncExecutions<Long> ardelrange(K key, ArrayIndexRange... ranges);
     ...
     */
    @Experimental
    AsyncExecutions<Long> arlen(K key);
     ...
     */
    @Experimental
    AsyncExecutions<Long> arcount(K key);
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> argetrange(K key, long start, long end);
     ...
     */
    @Experimental
    AsyncExecutions<Long> arnext(K key);
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> arlastitems(K key, long count);
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> arlastitems(K key, long count, boolean rev);
     ...
     */
    @Experimental
    AsyncExecutions<List<IndexedValue<V>>> arscan(K key, long start, long end);
     ...
     */
    @Experimental
    AsyncExecutions<List<IndexedValue<V>>> arscan(K key, long start, long end, long limit);
     ...
     */
    @Experimental
    AsyncExecutions<List<Long>> argrep(K key, ArGrepArgs grepArgs);
     ...
     */
    @Experimental
    AsyncExecutions<List<IndexedValue<V>>> argrepWithValues(K key, ArGrepArgs grepArgs);
     ...
     */
    @Experimental
    AsyncExecutions<V> aropAggregate(K key, long start, long end, ArAggregateType operation);
     ...
     */
    @Experimental
    AsyncExecutions<Long> aropBitwise(K key, long start, long end, ArBitwiseType operation);
     ...
     */
    @Experimental
    AsyncExecutions<Long> aropCount(K key, long start, long end);
     ...
     */
    @Experimental
    AsyncExecutions<Long> aropCount(K key, long start, long end, V matchValue);
     ...
     */
    @Experimental
    AsyncExecutions<Long> arinsert(K key, V value);
    ...
    @Experimental
    @SuppressWarnings("unchecked")
    AsyncExecutions<Long> arinsert(K key, V... values);
     ...
     */
    @Experimental
    AsyncExecutions<Long> arring(K key, long size, V value);
    ...
    @Experimental
    @SuppressWarnings("unchecked")
    AsyncExecutions<Long> arring(K key, long size, V... values);
     ...
     */
    @Experimental
    AsyncExecutions<Long> arseek(K key, long index);
     ...
     */
    @Experimental
    AsyncExecutions<ArrayInfo> arinfo(K key);
     ...
     */
    @Experimental
    AsyncExecutions<ArrayInfoFull> arinfoFull(K key);
