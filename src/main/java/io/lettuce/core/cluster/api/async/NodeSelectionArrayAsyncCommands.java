...
public interface NodeSelectionArrayAsyncCommands<K, V> {
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> argetrange(K key, Range<Long> range);
     ...
     */
    @Experimental
    AsyncExecutions<List<V>> arlastitemsRev(K key, long count);
     ...
     */
    @Experimental
    AsyncExecutions<List<IndexedValue<V>>> arscan(K key, ArScanArgs scanArgs);
     ...
     */
    @Experimental
    AsyncExecutions<V> aropAggregate(K key, Range<Long> range, ArAggregateType operation);
     ...
     */
    @Experimental
    AsyncExecutions<Long> aropCount(K key, Range<Long> range, ArCountType operation);
     ...
     */
    @Experimental
    AsyncExecutions<Long> aropMatch(K key, Range<Long> range, V matchValue);
     ...
     */
    @Experimental
    AsyncExecutions<ArrayMetadata> arinfo(K key);
     ...
     */
    @Experimental
    AsyncExecutions<ArrayFullMetadata> arinfoFull(K key);
