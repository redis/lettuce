...
public interface NodeSelectionSetCommands<K, V> {
     ...
     * @since 7.7
     */
    Executions<Long> sdiffcard(K... keys);
     ...
     * @since 7.7
     */
    Executions<Long> sdiffcard(long limit, K... keys);
     ...
     * @since 7.7
     */
    Executions<Long> sunioncard(K... keys);
     ...
     * @since 7.7
     */
    Executions<Long> sunioncard(SUnionCardArgs args, K... keys);
