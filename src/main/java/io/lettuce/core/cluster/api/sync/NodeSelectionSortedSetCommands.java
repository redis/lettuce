...
public interface NodeSelectionSortedSetCommands<K, V> {
     ...
     * @since 7.8
     */
    Executions<List<V>> zrange(K key, ZRange range);
     ...
     * @since 7.8
     */
    Executions<List<V>> zrange(K key, ZRange range, ZRangeArgs args);
     ...
     * @since 7.8
     */
    Executions<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange range);
     ...
     * @since 7.8
     */
    Executions<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange range, ZRangeArgs args);
