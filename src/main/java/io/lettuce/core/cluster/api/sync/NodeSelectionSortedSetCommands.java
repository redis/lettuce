...
public interface NodeSelectionSortedSetCommands<K, V> {
     ...
     * @since 7.7
     */
    Executions<List<V>> zrange(K key, ZRange<? extends V> range);
     ...
     * @since 7.7
     */
    Executions<List<V>> zrange(K key, ZRange<? extends V> range, ZRangeArgs args);
     ...
     * @since 7.7
     */
    Executions<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange<? extends V> range);
     ...
     * @since 7.7
     */
    Executions<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange<? extends V> range, ZRangeArgs args);
