...
public interface NodeSelectionKeyAsyncCommands<K, V> {
     ...
     */
    @Experimental
    AsyncExecutions<Long> delex(K key, CompareCondition<V> compareCondition);
     ...
     */
    @Experimental
    AsyncExecutions<String> digestKey(K key);
     ...
     */
    @Deprecated
    AsyncExecutions<List<K>> keysLegacy(K pattern);
     ...
     */
    @Deprecated
    AsyncExecutions<Long> keysLegacy(KeyStreamingChannel<K> channel, K pattern);
