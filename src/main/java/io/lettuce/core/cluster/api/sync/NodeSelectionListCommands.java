...
public interface NodeSelectionListCommands<K, V> {
     ...
     * @since 7.8
     */
    Executions<List<V>> blmovem(K source, K destination, LMovemArgs args, long timeout);
     ...
     * @since 7.8
     */
    Executions<List<V>> blmovem(K source, K destination, LMovemArgs args, double timeout);
