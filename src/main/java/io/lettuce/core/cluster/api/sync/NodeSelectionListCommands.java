...
public interface NodeSelectionListCommands<K, V> {
     ...
     * @since 6.1.3
     */
    Executions<V> blmove(K source, K destination, LMoveArgs args, double timeout);
     ...
     * @since 7.7
     */
    Executions<List<V>> blmovem(K source, K destination, BLMovemArgs args);
     ...
     * @since 6.2
     */
    Executions<KeyValue<K, List<V>>> blmpop(long timeout, LMPopArgs args, K... keys);
     ...
     * @since 6.2
     */
    Executions<KeyValue<K, List<V>>> blmpop(double timeout, LMPopArgs args, K... keys);
     ...
     * @since 6.1.3
     */
    Executions<KeyValue<K, V>> blpop(double timeout, K... keys);
     ...
     * @since 6.1.3
     */
    Executions<KeyValue<K, V>> brpop(double timeout, K... keys);
     ...
     * @since 7.7
     */
    Executions<List<V>> lmovem(K source, K destination, LMovemArgs args);
     ...
     * @since 6.2
     */
    Executions<KeyValue<K, List<V>>> lmpop(LMPopArgs args, K... keys);
     ...
     * @since 6.1
     */
    Executions<List<V>> lpop(K key, long count);
     ...
     * @since 6.1
     */
    Executions<List<V>> rpop(K key, long count);
