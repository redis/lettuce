...
public interface NodeSelectionStringAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<String> set(K key, V value, ValueCondition<V> condition);
     ...
     * @return String simple-string-reply {@code OK} if {@code SET} was executed; {@code null} if the operation was aborted.
     */
    AsyncExecutions<String> set(K key, V value, SetArgs setArgs, ValueCondition<V> condition);
     ...
     */
    AsyncExecutions<V> setGet(K key, V value, ValueCondition<V> condition);
     ...
     * @return V bulk-string-reply the previous value if the key existed, or {@code null} when {@code key} did not exist.
     */
    AsyncExecutions<V> setGet(K key, V value, SetArgs setArgs, ValueCondition<V> condition);
