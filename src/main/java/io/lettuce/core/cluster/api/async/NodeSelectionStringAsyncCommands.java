...
public interface NodeSelectionStringAsyncCommands<K, V> {
     ...
     * @since 7.1
     */
    AsyncExecutions<Boolean> msetex(Map<K, V> map, MSetExArgs args);
     ...
     * @since 7.8
     */
    AsyncExecutions<V> lcs(K key1, K key2);
     ...
     * @since 7.8
     */
    AsyncExecutions<StringMatchResult> lcs(K key1, K key2, LcsArgs lcsArgs);
