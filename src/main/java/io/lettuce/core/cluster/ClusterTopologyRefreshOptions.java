...
public class ClusterTopologyRefreshOptions {
    ...
    public static class Builder {
        ...
        /**
         * Flag, whether to close stale connections when refreshing the cluster topology. Defaults to {@code true}. Comes
         * only into effect if {@link #isPeriodicRefreshEnabled()} is {@code true}. See
         ...
         *
         * @param dynamicRefreshSources {@code true} to discover and query all cluster nodes for obtaining the cluster
         *        topology
         * @return {@code this}
         */
