...
/**
 * Helper class that encapsulates the specification of a method parameter, i.e. a {@link Method} or {@link Constructor} plus a
...
public class MethodParameter {
     ...
     * @param parameterIndex the index of the parameter: -1 for the method return type; 0 for the first method parameter; 1 for
     *        the second method parameter, etc.
     */
    ...
    public MethodParameter(MethodParameter original) {
        LettuceAssert.notNull(original, "Original must not be null");
     ...
     * <p>
     * This method does not actually try to retrieve the parameter name at this point; it just allows discovery to happen when
     * the application calls {@link #getParameterName()} (if ever).
     */
