...
/**
 * Internal utility class that can be used to obtain wrapped {@link Serializable} variants of {@link java.lang.reflect.Type}s.
 *
 * <p>
 * {@link #forField(Field) Fields} or {@link #forMethodParameter(MethodParameter) MethodParameters} can be used as the root
 * source for a serializable type. Alternatively the {@link #forGenericSuperclass(Class) superclass},
 * {@link #forGenericInterfaces(Class) interfaces} or {@link #forTypeParameters(Class) type parameters} or a regular
...
abstract class TypeWrapper {
    ...
    static Type forTypeProvider(final TypeProvider provider) {
        LettuceAssert.notNull(provider, "Provider must not be null");
    ...
    /**
     * {@link Serializable} {@link InvocationHandler} used by the proxied {@link Type}. Provides serialization support and
     * enhances any methods that return {@code Type} or {@code Type[]}.
     */
    @SuppressWarnings("serial")
