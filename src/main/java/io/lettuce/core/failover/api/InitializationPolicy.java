 ...
 *
 * <p>
 * An initialization policy determines when a multi-database connection is ready to be returned based on the availability of
 * individual database connections.
 * </p>
 * <p>
 * The policy is evaluated based on the completion status of database connection futures, and the decision to continue waiting,
 * succeed, or fail is based on the number of available, pending, and failed connections.
 * </p>
 *
 * @author Ali Takavci
 * @since 7.4
...
public interface InitializationPolicy {
    ...
    class BuiltIn {
        ...
        /*
         * All databases need to be available. The connection is ready only when all database connection futures have completed
         * successfully. If any connection fails, the initialization fails. If all connections are available, initialization
         * succeeds. Otherwise, continue waiting.
         */
        ...
        /*
         * A majority of databases need to be available. The connection is ready when more than half of the database connections
         * are available. This means initialization can succeed early once majority is reached, or fail early if majority
         * becomes impossible.
         */
        ...
        /*
         * At least one database needs to be available. The connection is ready as soon as any database connection is available.
         * Initialization fails only if all connections fail.
         */
