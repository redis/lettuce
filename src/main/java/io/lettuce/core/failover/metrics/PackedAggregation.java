...
/**
 * A measurement implementation used in sliding windows to track the total number of calls and failed calls in the window, along
 * with the number of calls and failed calls of the current entry/bucket.
 *
 * <p>
