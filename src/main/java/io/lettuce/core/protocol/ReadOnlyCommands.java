...
public class ReadOnlyCommands {
    ...
    enum CommandName {
        ...
        FT_AGGREGATE, FT_ALIASLIST, FT_SEARCH, FT_HYBRID, FT_EXPLAIN, FT_SPELLCHECK, FT_TAGVALS, FT_SYNDUMP, FT_LIST, FT_DICTDUMP,
        // Bloom Filter read-only commands
        BF_CARD, BF_EXISTS, BF_INFO, BF_MEXISTS, BF_SCANDUMP,
