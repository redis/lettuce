...
public enum CommandType implements ProtocolKeyword {
    ...
    BLMOVE, BLMOVEM, BLMPOP, BLPOP, BRPOP, BRPOPLPUSH, LINDEX, LINSERT, LLEN, LMOVE, LMOVEM, LMPOP, LPOP, LPOS, LPUSH, LPUSHX, LRANGE, LREM, LSET, LTRIM, RPOP, RPOPLPUSH, RPUSH, RPUSHX, SORT, SORT_RO,

    // Hash

    HDEL, HEXISTS, HGET, HGETDEL, HGETALL, HINCRBY, HINCRBYFLOAT, HKEYS, HLEN, HSTRLEN, HMGET, HMSET, HRANDFIELD, HSET, HSETEX, HGETEX, HSETNX, HVALS, HSCAN, HIMPORT,
    ...
    SADD, SCARD, SDIFF, SDIFFCARD, SDIFFSTORE, SINTER, SINTERCARD, SINTERSTORE, SISMEMBER, SMISMEMBER, SMEMBERS, SMOVE, SPOP, SRANDMEMBER, SREM, SSCAN, SUNION, SUNIONCARD, SUNIONSTORE,
    ...
    VADD, VCARD, VDIM, VEMB, VEMBRAW, VGETATTR, VINFO, VISMEMBER, VLINKS, VLINKSWITHSCORES, VRANDMEMBER, VREM, VSETATTR, VSIM, VSIMWITHSCORES,

    // RediSearch
    FT_AGGREGATE("FT.AGGREGATE"), FT_ALIASADD("FT.ALIASADD"), FT_ALIASDEL("FT.ALIASDEL"), FT_ALIASLIST(
            "FT.ALIASLIST"), FT_ALIASUPDATE("FT.ALIASUPDATE"), FT_ALTER("FT.ALTER"), FT_CREATE("FT.CREATE"), FT_CURSOR(
                    "FT.CURSOR"), FT_DICTADD("FT.DICTADD"), FT_DICTDEL("FT.DICTDEL"), FT_DICTDUMP("FT.DICTDUMP"), FT_DROPINDEX(
    ...
    // TimeSeries
    TS_CREATE("TS.CREATE"), TS_ALTER("TS.ALTER"), TS_CREATERULE("TS.CREATERULE"), TS_DELETERULE("TS.DELETERULE"), TS_DEL(
            "TS.DEL"), TS_ADD("TS.ADD"), TS_MADD("TS.MADD"), TS_INCRBY("TS.INCRBY"), TS_DECRBY(
                    "TS.DECRBY"), TS_GET("TS.GET"), TS_MGET("TS.MGET"), TS_INFO("TS.INFO"), TS_QUERYINDEX("TS.QUERYINDEX"),

    // CMS
    CMS_INCRBY("CMS.INCRBY"), CMS_INFO("CMS.INFO"), CMS_INITBYDIM("CMS.INITBYDIM"), CMS_INITBYPROB("CMS.INITBYPROB"), CMS_MERGE(
            "CMS.MERGE"), CMS_QUERY("CMS.QUERY"),

    // T-Digest
    TDIGEST_ADD("TDIGEST.ADD"), TDIGEST_BYRANK("TDIGEST.BYRANK"), TDIGEST_BYREVRANK("TDIGEST.BYREVRANK"), TDIGEST_CDF(
            "TDIGEST.CDF"), TDIGEST_CREATE("TDIGEST.CREATE"), TDIGEST_INFO("TDIGEST.INFO"), TDIGEST_MAX(
                    "TDIGEST.MAX"), TDIGEST_MERGE("TDIGEST.MERGE"), TDIGEST_MIN("TDIGEST.MIN"), TDIGEST_QUANTILE(
                            "TDIGEST.QUANTILE"), TDIGEST_RANK("TDIGEST.RANK"), TDIGEST_RESET("TDIGEST.RESET"), TDIGEST_REVRANK(
                                    "TDIGEST.REVRANK"), TDIGEST_TRIMMED_MEAN("TDIGEST.TRIMMED_MEAN"),
