...
public class CommandHandler extends ChannelDuplexHandler implements HasQueuedCommands {
    ...
    private void validateWrite(int commands) {
        ...
        if (usesBoundedQueues()) {
            ...
            int allowedRequestQueueSize = clientOptions.getRequestQueueSize() >= Integer.MAX_VALUE - maxMaintenanceCommands
                    ? Integer.MAX_VALUE
                    : clientOptions.getRequestQueueSize() + maxMaintenanceCommands;
