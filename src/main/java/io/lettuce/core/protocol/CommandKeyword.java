...
public enum CommandKeyword implements ProtocolKeyword {
    ...
    IDMP, IDMPAUTO, IDMP_DURATION("IDMP-DURATION"), IDMP_MAXSIZE(
            "IDMP-MAXSIZE"), MAX, MAXLEN, MEET, MIN, MINID, MINMATCHLEN, MOVED, NO, NOACK, NOCASE, NOCOMMANDS, NODE, NODES, NOMKSTREAM, NOPASS, NOSAVE, NOT, NOVALUES, NUMSUB, SHARDCHANNELS, SHARDNUMSUB, NUMPAT, NX, FNX, OFF, ON, ONE, OR, PAUSE, PREFIXES,
