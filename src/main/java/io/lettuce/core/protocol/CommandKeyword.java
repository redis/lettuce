...
public enum CommandKeyword implements ProtocolKeyword {
    ...
    IDMP, IDMPAUTO, IDMP_DURATION("IDMP-DURATION"), IDMP_MAXSIZE(
            "IDMP-MAXSIZE"), MAX, MAXLEN, MEET, MIN, MINID, MINMATCHLEN, MOVED, NO, NOACK, NOCOMMANDS, NODE, NODES, NOMKSTREAM, NOPASS, NOSAVE, NOT, NOVALUES, NUMSUB, SHARDCHANNELS, SHARDNUMSUB, NUMPAT, NX, FNX, OFF, ON, ONE, OR, PAUSE, PREFIXES,
    ...
    MIGRATING, IMPORTING, SAVE, SKIPME, SLAVES, STREAM, STORE, SUM, SEGFAULT, SETUSER, TAKEOVER, TOKENS, TRACKING, MAINT_NOTIFICATIONS, TRACKINGINFO, TYPE, UNBLOCK, USERS, USAGE, WEIGHTS, WHOAMI,
