...
public enum CommandKeyword implements ProtocolKeyword {
    ...
    BY, BYLEX, BYSCORE, CACHING, CAT, CH, CHANNELS, CLAIM, COPY, COUNT, COUNTKEYSINSLOT, CONSUMERS, CREATE, DB, DEBUG, DELSLOTS, DELSLOTSRANGE, DELUSER, DESC, DIFF, DIFF1, DRYRUN, EXACT, SOFT, HARD, ENCODING,
    ...
    // RedisTimeSeries keywords
    RETENTION, CHUNK_SIZE, DUPLICATE_POLICY, LABELS, IGNORE, AGGREGATION, ON_DUPLICATE, TIMESTAMP, LATEST, WITHLABELS, SELECTED_LABELS,
