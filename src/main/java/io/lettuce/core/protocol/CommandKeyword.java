...
public enum CommandKeyword implements ProtocolKeyword {
    ...
    BY, BYLEX, BYSCORE, CACHING, CAT, CH, CHANNELS, COPY, COUNT, COUNTKEYSINSLOT, CONSUMERS, CREATE, DB, DELSLOTS, DELUSER, DESC, DRYRUN, SOFT, HARD, ENCODING,
    ...
    REFCOUNT, REMOVE, RELOAD, REPLACE, REPLICATE, REV, RESET, RESETCHANNELS, RESETKEYS, RESETPASS,
