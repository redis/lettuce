...
public enum CommandKeyword implements ProtocolKeyword {
    ...
    BY, BYLEX, BYSCORE, CACHING, CHANNELS, COPY, COUNT, COUNTKEYSINSLOT, CONSUMERS, CREATE, DB, DELSLOTS, DESC, SOFT, HARD, ENCODING,
    ...
    REFCOUNT, REMOVE, RELOAD, REPLACE, REPLICATE, REV, RESET,
