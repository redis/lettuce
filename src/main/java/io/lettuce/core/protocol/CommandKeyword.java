...
public enum CommandKeyword implements ProtocolKeyword {
    ...
    MAX, MAXLEN, MEET, MIN, MOVED, NO, NOACK, NOCOMMANDS, NODE, NODES, NOMKSTREAM, NOPASS, NOSAVE, NOT, NUMSUB, NUMPAT, NX, OFF, ON, ONE, OR, PAUSE,
    ...
    MIGRATING, IMPORTING, SAVE, SKIPME, SLAVES, STREAM, STORE, SUM, SEGFAULT, SETUSER, SYNC, TRACKING, TYPE, UNBLOCK, USERS, USAGE, WEIGHTS, WHOAMI,
