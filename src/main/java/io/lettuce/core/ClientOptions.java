...
public class ClientOptions implements Serializable {
     ...
     * @return true/false
     */
    public boolean getCreateByteBufWhenRecvLargeKey() {
    ...
    /**
     * In the scenario of large keys, Whether we shoule create a new ByteBuf to avoid occasional large keys from causing
     * excessive memory
     *
     * @return true/false
     */
