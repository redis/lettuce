...
public class ClientOptions implements Serializable {
    ...
    public static class Builder {
        ...
        /**
         * Sets the {@literal PING} before activate connection flag. Defaults to {@code false}. See
    ...
    /**
     * Enables initial {@literal PING} barrier before any connection is usable. If {@code true} (default is {@code false} ),
