...
/**
 * Count/bitwise operations for the Redis {@code AROP} command that return an integer ({@code Long}).
 * <p>
 * These operations perform bitwise or counting operations over array elements in a given range.
 *
 * @author Aleksandar Todorov
 * @since 7.6
 * @see <a href="https://redis.io/docs/latest/commands/arop/">Redis Documentation: AROP</a>
 */
public enum ArCountType {
    ...
    /**
     * Returns the count of non-empty (populated) slots in the range.
     */
    USED
