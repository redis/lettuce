...
/**
 * Asynchronous executed commands for Count-Min Sketch.
 *
...
public interface RedisCMSAsyncCommands<K, V> {
     ...
     */
    RedisFuture<CMSInfoValue> cmsInfo(K key);
     ...
     */
    RedisFuture<String> cmsMerge(K destination, K source);
     ...
     * @return String simple-string-reply {@code OK} if {@code CMS.MERGE} was executed correctly.
     */
    RedisFuture<String> cmsMerge(K destination, K... sources);
     ...
     * @return String simple-string-reply {@code OK} if {@code CMS.MERGE} was executed correctly.
     */
    RedisFuture<String> cmsMerge(K destination, K source, long weight);
     ...
     */
    RedisFuture<List<Long>> cmsQuery(K key, V... values);
