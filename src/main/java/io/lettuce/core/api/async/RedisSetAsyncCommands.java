...
public interface RedisSetAsyncCommands<K, V> {
     ...
     * @since 7.7
     */
    RedisFuture<Long> sdiffcard(K key1, K key2);
     ...
     * @since 7.7
     */
    RedisFuture<Long> sdiffcard(List<K> keys);
     ...
     * @since 7.7
     */
    RedisFuture<Long> sdiffcard(K key1, K key2, SDiffCardArgs sdiffCardArgs);
     ...
     * @since 7.7
     */
    RedisFuture<Long> sdiffcard(List<K> keys, SDiffCardArgs sdiffCardArgs);
     ...
     * @since 7.7
     */
    RedisFuture<Long> sunioncard(K key1, K key2);
     ...
     * @since 7.7
     */
    RedisFuture<Long> sunioncard(List<K> keys);
     ...
     * @since 7.7
     */
    RedisFuture<Long> sunioncard(K key1, K key2, SUnionCardArgs sunionCardArgs);
     ...
     * @since 7.7
     */
    RedisFuture<Long> sunioncard(List<K> keys, SUnionCardArgs sunionCardArgs);
