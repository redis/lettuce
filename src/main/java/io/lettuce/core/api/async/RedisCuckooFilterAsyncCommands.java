 ...
 * @since 7.7
 */
public interface RedisCuckooFilterAsyncCommands<K, V> {
     ...
     * @return String simple-string-reply {@code OK} if {@code CF.RESERVE} was executed correctly.
     */
    RedisFuture<String> cfReserve(K key, long capacity, CfReserveArgs args);
     ...
     */
    RedisFuture<Boolean> cfAddNx(K key, V value);
     ...
     */
    RedisFuture<Boolean> cfExists(K key, V value);
     ...
     *         filter.
     */
    RedisFuture<List<Boolean>> cfMExists(K key, V... values);
     ...
     */
    RedisFuture<Boolean> cfDel(K key, V value);
     ...
     */
    RedisFuture<Long> cfCount(K key, V value);
     ...
     */
    RedisFuture<ScanDumpValue> cfScanDump(K key, long cursor);
     ...
     */
    RedisFuture<String> cfLoadChunk(K key, long cursor, byte[] data);
     ...
     */
    RedisFuture<CfInfoValue> cfInfo(K key);
