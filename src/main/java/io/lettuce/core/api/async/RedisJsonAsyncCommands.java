...
public interface RedisJsonAsyncCommands<K, V> {
     ...
     * @since 6.5
     */
    RedisFuture<List<Long>> jsonArrappend(K key, JsonPath jsonPath, JsonElement... elements);
     ...
     * @since 6.5
     */
    RedisFuture<List<Long>> jsonArrindex(K key, JsonPath jsonPath, JsonElement element, JsonRangeArgs range);
     ...
     * @since 6.5
     */
    RedisFuture<List<Long>> jsonArrinsert(K key, JsonPath jsonPath, int index, JsonElement... elements);
     ...
     * @since 6.5
     */
    RedisFuture<List<JsonElement>> jsonArrpop(K key, JsonPath jsonPath, int index);
     ...
     * @since 6.5
     */
    RedisFuture<JsonElement> jsonGet(K key, JsonGetArgs options, JsonPath... jsonPaths);
     ...
     */
    RedisFuture<Boolean> jsonMerge(K key, JsonPath jsonPath, JsonElement element);
     ...
     * @since 6.5
     */
    RedisFuture<List<JsonElement>> jsonMGet(JsonPath jsonPath, K... keys);
     ...
     * @since 6.5
     */
    RedisFuture<JsonElement> jsonNumincrby(K key, JsonPath jsonPath, Number number);
     ...
     * @since 6.5
     */
    RedisFuture<Boolean> jsonSet(K key, JsonPath jsonPath, JsonElement element, JsonSetArgs options);
     ...
     * @since 6.5
     */
    RedisFuture<List<Long>> jsonStrappend(K key, JsonPath jsonPath, JsonElement element);
