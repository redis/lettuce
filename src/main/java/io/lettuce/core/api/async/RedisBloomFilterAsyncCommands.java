 ...
 * @since 7.7
 */
public interface RedisBloomFilterAsyncCommands<K, V> {
     ...
     */
    RedisFuture<Boolean> bfAdd(K key, V value);
     ...
     */
    RedisFuture<Boolean> bfExists(K key, V value);
     ...
     */
    RedisFuture<BfInfoValue> bfInfo(K key);
     ...
     *         and nonscaling.
     */
    RedisFuture<List<Boolean>> bfInsert(K key, V value);
     ...
     *         and nonscaling.
     */
    RedisFuture<List<Boolean>> bfInsert(K key, BfInsertArgs insertArgs, V value);
     ...
     *         and nonscaling.
     */
    RedisFuture<List<Boolean>> bfInsert(K key, V... values);
     ...
     *         and nonscaling.
     */
    RedisFuture<List<Boolean>> bfInsert(K key, BfInsertArgs insertArgs, V... values);
     ...
     */
    RedisFuture<String> bfLoadChunk(K key, long iterator, byte[] data);
     ...
     *         and nonscaling.
     */
    RedisFuture<List<Boolean>> bfMAdd(K key, V... values);
     ...
     *         filter.
     */
    RedisFuture<List<Boolean>> bfMExists(K key, V... values);
     ...
     * @return String simple-string-reply {@code OK} if {@code BF.RESERVE} was executed correctly.
     */
    RedisFuture<String> bfReserve(K key, double errorRate, long capacity, BfReserveArgs reserveArgs);
