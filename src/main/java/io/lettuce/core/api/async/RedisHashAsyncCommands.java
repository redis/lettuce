...
public interface RedisHashAsyncCommands<K, V> {
     ...
     * @since 7.7
     */
    RedisFuture<String> himportPrepare(K fieldsetName, K field);
     ...
     * @since 7.7
     */
    RedisFuture<String> himportPrepare(K fieldsetName, K... fields);
     ...
     * @since 7.7
     */
    RedisFuture<String> himportSet(K key, K fieldsetName, V value);
     ...
     * @since 7.7
     */
    RedisFuture<String> himportSet(K key, K fieldsetName, V... values);
     ...
     * @since 7.7
     */
    RedisFuture<Boolean> himportDiscard(K fieldsetName);
