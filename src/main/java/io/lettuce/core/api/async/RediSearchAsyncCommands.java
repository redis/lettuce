...
public interface RediSearchAsyncCommands<K, V> {
     ...
     */
    @Experimental
    RedisFuture<AggregationReply<K, V>> ftCursorread(K index, Cursor cursor, int count);
     ...
     */
    @Experimental
    RedisFuture<AggregationReply<K, V>> ftCursorread(K index, Cursor cursor);
     ...
     */
    @Experimental
    RedisFuture<String> ftCursordel(K index, Cursor cursor);
