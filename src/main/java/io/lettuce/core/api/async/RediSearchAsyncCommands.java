...
public interface RediSearchAsyncCommands<K, V> {
     ...
     */
    @Experimental
    RedisFuture<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query);
     ...
     */
    @Experimental
    RedisFuture<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query, SearchArgs<K, V> searchArgs);
     ...
     */
    @Experimental
    RedisFuture<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query, AggregateArgs<K, V> aggregateArgs);
