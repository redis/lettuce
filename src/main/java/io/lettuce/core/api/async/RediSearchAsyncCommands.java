 ...
 * @since 6.8
 */
public interface RediSearchAsyncCommands<K> {
     ...
     */
    @Experimental
    RedisFuture<List<String>> ftTagvals(String index, String fieldName);
     ...
     */
    @Experimental
    RedisFuture<SpellCheckResult> ftSpellcheck(String index, String query);
     ...
     */
    @Experimental
    RedisFuture<SpellCheckResult> ftSpellcheck(String index, String query, SpellCheckArgs args);
     ...
     */
    @Experimental
    RedisFuture<Long> ftDictadd(String dict, String... terms);
     ...
     */
    @Experimental
    RedisFuture<Long> ftDictdel(String dict, String... terms);
     ...
     */
    @Experimental
    RedisFuture<List<String>> ftDictdump(String dict);
     ...
     */
    @Experimental
    RedisFuture<String> ftExplain(String index, String query);
     ...
     */
    @Experimental
    RedisFuture<String> ftExplain(String index, String query, ExplainArgs args);
     ...
     */
    @Experimental
    RedisFuture<List<String>> ftList();
     ...
     */
    @Experimental
    RedisFuture<Map<String, List<String>>> ftSyndump(String index);
     ...
     */
    @Experimental
    RedisFuture<String> ftSynupdate(String index, String synonymGroupId, String... terms);
     ...
     */
    @Experimental
    RedisFuture<String> ftSynupdate(String index, String synonymGroupId, SynUpdateArgs args, String... terms);
     ...
     */
    @Experimental
    RedisFuture<SearchReply<K>> ftSearch(String index, String query);
     ...
     */
    @Experimental
    RedisFuture<SearchReply<K>> ftSearch(String index, String query, SearchArgs<K> args);
     ...
     */
    @Experimental
    RedisFuture<AggregationReply<K>> ftAggregate(String index, String query);
     ...
     */
    @Experimental
    RedisFuture<AggregationReply<K>> ftAggregate(String index, String query, AggregateArgs args);
     ...
     */
    @Experimental
    RedisFuture<AggregationReply<K>> ftCursorread(String index, Cursor cursor, int count);
     ...
     */
    @Experimental
    RedisFuture<AggregationReply<K>> ftCursorread(String index, Cursor cursor);
     ...
     */
    @Experimental
    RedisFuture<String> ftCursordel(String index, Cursor cursor);
     ...
     */
    @Experimental
    RedisFuture<HybridReply<K>> ftHybrid(String index, HybridArgs args);
