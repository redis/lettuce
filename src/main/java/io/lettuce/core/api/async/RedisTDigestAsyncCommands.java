...
public interface RedisTDigestAsyncCommands<K, V> {
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    RedisFuture<String> tdigestAdd(K key, double... values);
     ...
     */
    RedisFuture<List<Double>> tdigestCDF(K key, double value);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    RedisFuture<String> tdigestMerge(K destination, K sourceKey, TDigestMergeArgs mergeArgs);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    RedisFuture<String> tdigestMerge(K destination, TDigestMergeArgs mergeArgs, K... sourceKeys);
     ...
     */
    RedisFuture<List<Long>> tdigestRank(K key, double value);
     ...
     */
    RedisFuture<List<Long>> tdigestRevRank(K key, double value);
