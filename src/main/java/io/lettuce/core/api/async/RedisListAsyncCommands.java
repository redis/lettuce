...
public interface RedisListAsyncCommands<K, V> {
     ...
     * @since 7.7
     */
    RedisFuture<List<V>> blmovem(K source, K destination, BLMovemArgs args);
     ...
     * @since 6.2
     */
    RedisFuture<KeyValue<K, List<V>>> blmpop(long timeout, LMPopArgs args, K... keys);
     ...
     * @since 6.2
     */
    RedisFuture<KeyValue<K, List<V>>> blmpop(double timeout, LMPopArgs args, K... keys);
     ...
     * @since 7.7
     */
    RedisFuture<List<V>> lmovem(K source, K destination, LMovemArgs args);
     ...
     * @since 6.2
     */
    RedisFuture<KeyValue<K, List<V>>> lmpop(LMPopArgs args, K... keys);
