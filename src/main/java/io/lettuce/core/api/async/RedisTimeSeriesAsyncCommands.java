...
/**
 * Asynchronous executed commands for RedisTimeSeries.
 *
 * @author Gyumin Hwang
 * @param <K> Key type.
 * @param <V> Value type.
...
public interface RedisTimeSeriesAsyncCommands<K, V> {
     ...
     */
    RedisFuture<String> tsCreate(K key);
     ...
     * @return String simple-string-reply {@code OK} if {@code TS.CREATE} was executed correctly.
     */
    RedisFuture<String> tsCreate(K key, TsCreateArgs createArgs);
     ...
     */
    RedisFuture<String> tsAlter(K key);
     ...
     * @return String simple-string-reply {@code OK} if {@code TS.ALTER} was executed correctly.
     */
    RedisFuture<String> tsAlter(K key, TsAlterArgs alterArgs);
     ...
     */
    RedisFuture<String> tsCreateRule(K sourceKey, K destKey, TsAggregationType aggregationType, long bucketDuration);
     ...
     */
    RedisFuture<Long> tsDel(K key, long fromTimestamp, long toTimestamp);
     ...
     */
    RedisFuture<Long> tsAdd(K key, long timestamp, double value);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    RedisFuture<Long> tsAdd(K key, long timestamp, double value, TsAddArgs addArgs);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    RedisFuture<Long> tsAdd(K key, double value);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    RedisFuture<Long> tsAdd(K key, double value, TsAddArgs addArgs);
     ...
     */
    RedisFuture<List<Long>> tsMAdd(Map.Entry<K, TsSample>... entries);
     ...
     */
    RedisFuture<List<Long>> tsMAdd(Map.Entry<K, TsSample> entry);
     ...
     * @return Long integer-reply the timestamp of the updated sample.
     */
    RedisFuture<Long> tsIncrBy(K key, double value, TsIncrByArgs incrByArgs);
     ...
     * @return Long integer-reply the timestamp of the updated sample.
     */
    RedisFuture<Long> tsDecrBy(K key, double value, TsIncrByArgs decrByArgs);
     ...
     */
    RedisFuture<TsSample> tsGet(K key);
     ...
     * @return TsSample the last sample of the time series, or {@code null} if the series has no samples.
     */
    RedisFuture<TsSample> tsGet(K key, boolean latest);
     ...
     */
    RedisFuture<TsInfoValue<K>> tsInfo(K key);
     ...
     *         {@code true}.
     */
    RedisFuture<TsInfoValue<K>> tsInfo(K key, boolean debug);
