...
/**
 * Asynchronous executed commands for Vector Sets
 * <p>
...
public interface RedisVectorSetAsyncCommands<K, V> {
     ...
     */
    @Experimental
    RedisFuture<Boolean> vadd(K key, V element, Double... vectors);
     ...
     */
    @Experimental
    RedisFuture<Boolean> vadd(K key, int dimensionality, V element, Double... vectors);
     ...
     */
    @Experimental
    RedisFuture<Boolean> vadd(K key, V element, VAddArgs args, Double... vectors);
     ...
     */
    @Experimental
    RedisFuture<Boolean> vadd(K key, int dimensionality, V element, VAddArgs args, Double... vectors);
     ...
     */
    @Experimental
    RedisFuture<Boolean> vClearAttributes(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<List<Double>> vemb(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<RawVector> vembRaw(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<String> vgetattr(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<List<JsonValue>> vgetattrAsJsonValue(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<VectorMetadata> vinfo(K key);
     ...
     */
    @Experimental
    RedisFuture<V> vrandmember(K key);
     ...
     */
    @Experimental
    RedisFuture<List<V>> vrandmember(K key, int count);
     ...
     */
    @Experimental
    RedisFuture<Boolean> vrem(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<Boolean> vsetattr(K key, V element, String json);
     ...
     */
    @Experimental
    RedisFuture<Boolean> vsetattr(K key, V element, JsonValue json);
     ...
     */
    @Experimental
    RedisFuture<List<V>> vsim(K key, Double... vectors);
     ...
     */
    @Experimental
    RedisFuture<List<V>> vsim(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<List<V>> vsim(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    RedisFuture<List<V>> vsim(K key, VSimArgs args, V element);
     ...
     */
    @Experimental
    RedisFuture<Map<V, Double>> vsimWithScore(K key, Double... vectors);
     ...
     */
    @Experimental
    RedisFuture<Map<V, Double>> vsimWithScore(K key, V element);
     ...
     */
    @Experimental
    RedisFuture<Map<V, Double>> vsimWithScore(K key, VSimArgs args, Double... vectors);
