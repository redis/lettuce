...
public interface RedisSortedSetAsyncCommands<K, V> {
     ...
     * @since 7.8
     */
    RedisFuture<List<V>> zrange(K key, ZRange.ByIndex range);
     ...
     * @since 7.8
     */
    RedisFuture<List<V>> zrange(K key, ZRange.ByScore range);
     ...
     * @since 7.8
     */
    RedisFuture<Long> zrange(ValueStreamingChannel<V> channel, K key, ZRange.ByIndex range);
     ...
     * @since 7.8
     */
    RedisFuture<Long> zrange(ValueStreamingChannel<V> channel, K key, ZRange.ByScore range);
     ...
     * @since 7.8
     */
    RedisFuture<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange.ByIndex range);
     ...
     * @since 7.8
     */
    RedisFuture<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange.ByScore range);
     ...
     * @since 7.8
     */
    RedisFuture<Long> zrangeWithScores(ScoredValueStreamingChannel<V> channel, K key, ZRange.ByIndex range);
     ...
     * @since 7.8
     */
    RedisFuture<Long> zrangeWithScores(ScoredValueStreamingChannel<V> channel, K key, ZRange.ByScore range);
