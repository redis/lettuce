...
public interface RedisSortedSetAsyncCommands<K, V> {
     ...
     * @since 7.8
     */
    RedisFuture<List<V>> zrange(K key, ZRange range);
     ...
     * @since 7.8
     */
    RedisFuture<List<V>> zrange(K key, ZRange range, ZRangeArgs args);
     ...
     * @since 7.8
     */
    RedisFuture<List<V>> zrange(K key, ZLexRange<? extends V> range);
     ...
     * @since 7.8
     */
    RedisFuture<List<V>> zrange(K key, ZLexRange<? extends V> range, ZRangeArgs args);
     ...
     * @since 7.8
     */
    RedisFuture<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange range);
     ...
     * @since 7.8
     */
    RedisFuture<List<ScoredValue<V>>> zrangeWithScores(K key, ZRange range, ZRangeArgs args);
