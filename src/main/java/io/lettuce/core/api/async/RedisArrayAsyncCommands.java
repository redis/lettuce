...
/**
 * Asynchronous executed commands for the Redis Array data type.
 * <p>
 ...
 * @since 7.6
 */
public interface RedisArrayAsyncCommands<K, V> {
     ...
     */
    @Experimental
    RedisFuture<List<Long>> argrep(K key, ArGrepArgs grepArgs);
     ...
     */
    @Experimental
    RedisFuture<List<IndexedValue<V>>> argrepWithValues(K key, ArGrepArgs grepArgs);
