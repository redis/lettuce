...
public interface RedisArrayAsyncCommands<K, V> {
    ...
    RedisFuture<Long> ardelrange(K key, Range<Long>... ranges);
     ...
     */
    @Experimental
    RedisFuture<List<V>> argetrange(K key, Range<Long> range);
     ...
     */
    @Experimental
    RedisFuture<List<V>> arlastitemsRev(K key, long count);
     ...
     */
    @Experimental
    RedisFuture<List<IndexedValue<V>>> arscan(K key, ArScanArgs scanArgs);
     ...
     */
    @Experimental
    RedisFuture<V> aropAggregate(K key, Range<Long> range, ArAggregateType operation);
     ...
     */
    @Experimental
    RedisFuture<Long> aropCount(K key, Range<Long> range, ArCountType operation);
     ...
     */
    @Experimental
    RedisFuture<Long> aropMatch(K key, Range<Long> range, V matchValue);
     ...
     */
    @Experimental
    RedisFuture<ArrayMetadata> arinfo(K key);
     ...
     */
    @Experimental
    RedisFuture<ArrayFullMetadata> arinfoFull(K key);
