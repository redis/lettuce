...
/**
 * Synchronous executed commands for JSON documents
 *
 * @param <K> Key type.
 * @param <V> Value type.
...
public interface RedisJsonCommands<K, V> {
     ...
     * @since 6.8
     */
    List<Long> jsonArrappend(K key, String... jsonStrings);
     ...
     * @since 7.0
     */
    List<String> jsonArrpopRaw(K key, JsonPath jsonPath, int index);
     ...
     * @since 7.0
     */
    List<String> jsonArrpopRaw(K key, JsonPath jsonPath);
     ...
     * @since 7.0
     */
    List<String> jsonArrpopRaw(K key);
     ...
     * @since 7.0
     */
    List<String> jsonMGetRaw(JsonPath jsonPath, K... keys);
     ...
     * @since 6.8
     */
    String jsonSet(K key, JsonPath jsonPath, String jsonString);
     ...
     * @since 6.8
     */
    List<Long> jsonStrappend(K key, String jsonString);
