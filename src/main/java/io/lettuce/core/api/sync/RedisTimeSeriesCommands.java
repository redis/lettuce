...
/**
 * Synchronous executed commands for RedisTimeSeries.
 *
 * @author Gyumin Hwang
 * @param <K> Key type.
 * @param <V> Value type.
...
public interface RedisTimeSeriesCommands<K, V> {
     ...
     * @return String simple-string-reply {@code OK} if {@code TS.CREATE} was executed correctly.
     */
    String tsCreate(K key, TsCreateArgs createArgs);
     ...
     * @return String simple-string-reply {@code OK} if {@code TS.ALTER} was executed correctly.
     */
    String tsAlter(K key, TsAlterArgs alterArgs);
     ...
     */
    String tsCreateRule(K sourceKey, K destKey, TsAggregationType aggregationType, long bucketDuration);
     ...
     * @return String simple-string-reply {@code OK} if {@code TS.CREATERULE} was executed correctly.
     */
    String tsCreateRule(K sourceKey, K destKey, TsAggregationType aggregationType, long bucketDuration, long alignTimestamp);
     ...
     */
    Long tsDel(K key, long fromTimestamp, long toTimestamp);
     ...
     */
    Long tsAdd(K key, long timestamp, double value);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    Long tsAdd(K key, long timestamp, double value, TsAddArgs addArgs);
     ...
     * @return Long integer-reply the timestamp that was ultimately used for the sample.
     */
    Long tsAdd(K key, double value, TsAddArgs addArgs);
     ...
     * @return Long integer-reply the timestamp of the updated sample.
     */
    Long tsIncrBy(K key, double value, TsIncrByArgs incrByArgs);
     ...
     * @return Long integer-reply the timestamp of the updated sample.
     */
    Long tsDecrBy(K key, double value, TsIncrByArgs decrByArgs);
     ...
     * @return TsSample the last sample of the time series, or {@code null} if the series has no samples.
     */
    TsSample tsGet(K key, boolean latest);
     ...
     */
    List<TsMGetValue<K>> tsMGet(TsFilter... filters);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    List<TsMGetValue<K>> tsMGet(TsFilter filter);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    List<TsMGetValue<K>> tsMGet(TsMGetArgs mGetArgs, TsFilter... filters);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    List<TsMGetValue<K>> tsMGet(TsMGetArgs mGetArgs, TsFilter filter);
     ...
     *         {@code true}.
     */
    TsInfoValue<K> tsInfo(K key, boolean debug);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    List<K> tsQueryIndex(TsFilter... filters);
     ...
     * @throws io.lettuce.core.RedisCommandExecutionException if no filter is an equality filter.
     */
    List<K> tsQueryIndex(TsFilter filter);
