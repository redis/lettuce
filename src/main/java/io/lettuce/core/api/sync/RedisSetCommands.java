...
public interface RedisSetCommands<K, V> {
     ...
     * @since 7.7
     */
    Long sdiffcard(K key1, K key2, SDiffCardArgs sdiffCardArgs);
     ...
     * @since 7.7
     */
    Long sdiffcard(List<K> keys, SDiffCardArgs sdiffCardArgs);
     ...
     * @since 6.2
     */
    Long sintercard(long limit, K... keys);
     ...
     * @since 7.7
     */
    Long sunioncard(K key1, K key2, SUnionCardArgs sunionCardArgs);
     ...
     * @since 7.7
     */
    Long sunioncard(List<K> keys, SUnionCardArgs sunionCardArgs);
