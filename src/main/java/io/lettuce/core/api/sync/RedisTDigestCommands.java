...
public interface RedisTDigestCommands<K, V> {
     ...
     */
    String tdigestAdd(K key, double value);
     ...
     */
    List<Double> tdigestCDF(K key, double value);
     ...
     */
    List<Long> tdigestRank(K key, double value);
     ...
     */
    List<Long> tdigestRevRank(K key, double value);
