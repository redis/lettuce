...
/**
 * Synchronous executed commands for Count-Min Sketch.
 *
...
public interface RedisCMSCommands<K, V> {
     ...
     * @since 7.8
     */
    String cmsInitByDim(K key, long width, long depth, int cellSize);
     ...
     * @since 7.8
     */
    String cmsInitByProb(K key, double error, double probability, int cellSize);
     ...
     * @return String simple-string-reply {@code OK} if {@code CMS.MERGE} was executed correctly.
     */
    String cmsMerge(K destination, MergePair<K> pair);
