...
/**
 * Synchronous executed commands for Vector Sets
 * <p>
...
public interface RedisVectorSetCommands<K, V> {
     ...
     */
    @Experimental
    Boolean vadd(K key, V element, Double... vectors);
     ...
     */
    @Experimental
    Boolean vadd(K key, int dimensionality, V element, Double... vectors);
     ...
     */
    @Experimental
    Boolean vadd(K key, V element, VAddArgs args, Double... vectors);
     ...
     */
    @Experimental
    Boolean vadd(K key, int dimensionality, V element, VAddArgs args, Double... vectors);
     ...
     */
    @Experimental
    Boolean vismember(K key, V element);
     ...
     */
    @Experimental
    Boolean vClearAttributes(K key, V element);
     ...
     */
    @Experimental
    List<Double> vemb(K key, V element);
     ...
     */
    @Experimental
    List<JsonValue> vgetattrAsJsonValue(K key, V element);
     ...
     */
    @Experimental
    Boolean vsetattr(K key, V element, JsonValue json);
     ...
     */
    @Experimental
    List<V> vsim(K key, Double... vectors);
     ...
     */
    @Experimental
    List<V> vsim(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    Map<V, VSimScoreAttribs> vsimWithScoreWithAttribs(K key, Double... vectors);
     ...
     */
    @Experimental
    Map<V, VSimScoreAttribs> vsimWithScoreWithAttribs(K key, V element);
     ...
     */
    @Experimental
    Map<V, VSimScoreAttribs> vsimWithScoreWithAttribs(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    Map<V, VSimScoreAttribs> vsimWithScoreWithAttribs(K key, VSimArgs args, V element);
