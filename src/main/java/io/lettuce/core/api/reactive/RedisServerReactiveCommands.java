...
public interface RedisServerReactiveCommands<K, V> {
     ...
     * @since 7.7
     */
    Mono<String> clientNoTouch(boolean on);
     ...
     */
    @Experimental
    Mono<String> hotkeysStart(HotkeysArgs args);
