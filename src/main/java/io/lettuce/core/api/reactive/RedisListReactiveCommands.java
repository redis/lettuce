...
public interface RedisListReactiveCommands<K, V> {
     ...
     *        count block.
     * @return V array-reply the elements being popped and pushed, or an empty list when the timeout was reached or
     *         {@code EXACTLY} cannot be satisfied.
     * @since 7.7
     */
    Flux<V> blmovem(K source, K destination, BLMovemArgs args);
