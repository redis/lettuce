...
public interface RedisJsonReactiveCommands<K, V> {
     ...
     * @since 6.5
     */
    Flux<Long> jsonArrappend(K key, JsonPath jsonPath, JsonElement... elements);
     ...
     * @since 6.5
     */
    Flux<Long> jsonArrindex(K key, JsonPath jsonPath, JsonElement element, JsonRangeArgs range);
     ...
     * @since 6.5
     */
    Flux<Long> jsonArrinsert(K key, JsonPath jsonPath, int index, JsonElement... elements);
     ...
     * @since 6.5
     */
    Flux<JsonElement> jsonArrpop(K key, JsonPath jsonPath, int index);
     ...
     * @since 6.5
     */
    Mono<JsonElement> jsonGet(K key, JsonGetArgs options, JsonPath... jsonPaths);
     ...
     */
    Mono<Boolean> jsonMerge(K key, JsonPath jsonPath, JsonElement element);
     ...
     * @since 6.5
     */
    Flux<JsonElement> jsonMGet(JsonPath jsonPath, K... keys);
     ...
     * @since 6.5
     */
    Mono<JsonElement> jsonNumincrby(K key, JsonPath jsonPath, Number number);
     ...
     * @since 6.5
     */
    Mono<Boolean> jsonSet(K key, JsonPath jsonPath, JsonElement element, JsonSetArgs options);
     ...
     * @since 6.5
     */
    Flux<Long> jsonStrappend(K key, JsonPath jsonPath, JsonElement element);
