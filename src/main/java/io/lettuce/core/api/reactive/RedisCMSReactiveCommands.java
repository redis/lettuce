...
/**
 * Reactive executed commands for Count-Min Sketch.
 *
...
public interface RedisCMSReactiveCommands<K, V> {
     ...
     * @return Long array-reply of the count of the item after the increment.
     */
     ...
     * @return Long array-reply of the count of each item after the increment, in the same order as {@code pairs}.
     */
     ...
     */
    Mono<CMSInfoValue> cmsInfo(K key);
     ...
     * @since 7.8
     */
    Mono<String> cmsInitByDim(K key, long width, long depth, int cellSize);
     ...
     * @since 7.8
     */
    Mono<String> cmsInitByProb(K key, double error, double probability, int cellSize);
     ...
     */
    Mono<String> cmsMerge(K destination, K source);
     ...
     * @return String simple-string-reply {@code OK} if {@code CMS.MERGE} was executed correctly.
     */
    Mono<String> cmsMerge(K destination, K... sources);
     ...
     * @return String simple-string-reply {@code OK} if {@code CMS.MERGE} was executed correctly.
     */
    Mono<String> cmsMerge(K destination, MergePair<K> pair);
     ...
     * @return String simple-string-reply {@code OK} if {@code CMS.MERGE} was executed correctly.
     */
    Mono<String> cmsMerge(K destination, MergePair<K>... sources);
     ...
     * @return Long array-reply of the count of the item.
     */
    Flux<Long> cmsQuery(K key, V value);
     ...
     * @return Long array-reply of the count of each item, in the same order as {@code values}.
     */
    Flux<Long> cmsQuery(K key, V... values);
