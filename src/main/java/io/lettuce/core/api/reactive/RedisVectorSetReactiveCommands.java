...
public interface RedisVectorSetReactiveCommands<K, V> {
     ...
     */
    @Experimental
    Mono<Boolean> vismember(K key, V element);
     ...
     */
    @Experimental
    Flux<JsonValue> vgetattrAsJsonValue(K key, V element);
     ...
     */
    @Experimental
    Mono<Boolean> vsetattr(K key, V element, JsonValue json);
     ...
     */
    @Experimental
    Mono<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, Double... vectors);
     ...
     */
    @Experimental
    Mono<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, V element);
     ...
     */
    @Experimental
    Mono<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, VSimArgs args, Double... vectors);
     ...
     */
    @Experimental
    Mono<Map<V, VSimScoreAttribs>> vsimWithScoreWithAttribs(K key, VSimArgs args, V element);
