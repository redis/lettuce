...
public interface RedisSortedSetReactiveCommands<K, V> {
     ...
     * @since 7.8
     */
    Flux<V> zrange(K key, ZRange range);
     ...
     * @since 7.8
     */
    Flux<V> zrange(K key, ZRange range, ZRangeArgs args);
     ...
     * @since 7.8
     */
    Flux<ScoredValue<V>> zrangeWithScores(K key, ZRange range);
     ...
     * @since 7.8
     */
    Flux<ScoredValue<V>> zrangeWithScores(K key, ZRange range, ZRangeArgs args);
