...
public interface RedisSortedSetReactiveCommands<K, V> {
     ...
     * @since 6.3
     */
    Mono<KeyValue<K, ScoredValue<V>>> bzmpop(long timeout, ZPopArgs args, K... keys);
     ...
     * @since 6.3
     */
    Mono<KeyValue<K, ScoredValue<V>>> bzmpop(double timeout, ZPopArgs args, K... keys);
     ...
     * @since 4.3
     */
    Mono<Double> zaddincr(K key, ZAddArgs zAddArgs, double score, V member);
     ...
     * @return Double array-reply list of scores or nil associated with the specified member values.
     * @since 6.1
     */
     ...
     * @since 6.3
     */
    Mono<KeyValue<K, ScoredValue<V>>> zmpop(ZPopArgs args, K... keys);
     ...
     * @since 5.1
     */
    Flux<ScoredValue<V>> zpopmin(K key, long count);
     ...
     * @since 5.1
     */
    Flux<ScoredValue<V>> zpopmax(K key, long count);
     ...
     * @since 6.1
     */
    Flux<V> zrandmember(K key, long count);
     ...
     * @since 6.1
     */
    Flux<ScoredValue<V>> zrandmemberWithScores(K key, long count);
     ...
     * @since 7.8
     */
    Flux<V> zrange(K key, ZRange.ByIndex range);
     ...
     * @since 7.8
     */
    Flux<V> zrange(K key, ZRange.ByScore range);
     ...
     * @since 7.8
     */
    Flux<ScoredValue<V>> zrangeWithScores(K key, ZRange.ByIndex range);
