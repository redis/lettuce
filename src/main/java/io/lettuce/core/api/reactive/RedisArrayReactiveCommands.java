...
/**
 * Reactive executed commands for the Redis Array data type.
 * <p>
 ...
 * @since 7.6
 */
public interface RedisArrayReactiveCommands<K, V> {
     ...
     */
    @Experimental
    Flux<IndexedValue<V>> argrepWithValues(K key, ArGrepArgs grepArgs);
