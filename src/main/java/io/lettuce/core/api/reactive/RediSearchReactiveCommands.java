...
public interface RediSearchReactiveCommands<K, V> {
     ...
     */
    @Experimental
    Mono<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query);
     ...
     */
    @Experimental
    Mono<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query, SearchArgs<K, V> searchArgs);
     ...
     */
    @Experimental
    Mono<ProfileResult> ftProfile(K index, ProfileArgs<K, V> profileArgs, V query, AggregateArgs<K, V> aggregateArgs);
