...
public interface RedisTDigestReactiveCommands<K, V> {
     ...
     *         rank is equal to or exceeds the number of observations and {@code nan} if the sketch is empty.
     */
     ...
     *         is equal to or exceeds the number of observations. All entries are {@code nan} if the sketch is empty.
     */
     ...
     * @return Double a single-element list holding the estimated value with the given reverse rank. The value is {@code -inf}
     *         if the reverse rank is equal to or exceeds the number of observations and {@code nan} if the sketch is empty.
     */
     ...
     *         {@code -inf} if the reverse rank is equal to or exceeds the number of observations. All entries are {@code nan}
