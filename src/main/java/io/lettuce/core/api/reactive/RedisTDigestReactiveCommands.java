...
/**
 * Reactive executed commands for T-Digest sketch.
 *
 ...
 * @since 7.7
 */
public interface RedisTDigestReactiveCommands<K, V> {
     ...
     * @return Double a single-element list holding the estimated value with the given rank. The value is {@code -inf} if the
     *         rank is negative and {@code inf} if the rank exceeds the number of observations.
     */
    Flux<Double> tdigestByRank(K key, long rank);
     ...
     * @return Double one entry per input rank holding the estimated value with that rank. An entry is {@code -inf} if the rank
     *         is negative and {@code inf} if the rank exceeds the number of observations.
     */
     ...
     * @return Double a single-element list holding the estimated value with the given reverse rank. The value is {@code inf} if
     *         the reverse rank is negative and {@code -inf} if it exceeds the number of observations.
     */
    Flux<Double> tdigestByRevRank(K key, long reverseRank);
     ...
     * @return Double one entry per input reverse rank holding the estimated value with that reverse rank. An entry is
     *         {@code inf} if the reverse rank is negative and {@code -inf} if it exceeds the number of observations.
     */
    Flux<Double> tdigestByRevRank(K key, long... reverseRanks);
     ...
     */
    Mono<TDigestInfoValue> tdigestInfo(K key);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, K sourceKey);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, K sourceKey, boolean override);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, K sourceKey, long compression);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, K sourceKey, long compression, boolean override);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, K... sourceKeys);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, boolean override, K... sourceKeys);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, long compression, K... sourceKeys);
     ...
     * @return String simple-string-reply {@code OK} if the command was executed correctly.
     */
    Mono<String> tdigestMerge(K destination, long compression, boolean override, K... sourceKeys);
     ...
     * @return Double a single-element list holding the estimated value at the given quantile, or {@code nan} if the sketch is
     *         empty.
     */
    Flux<Double> tdigestQuantile(K key, double quantile);
     ...
     * @return Double one entry per input quantile holding the estimated value at that quantile, or {@code nan} if the sketch is
     *         empty.
     */
     ...
     * @return Long a single-element list holding the estimated rank of the value. The rank is {@code -1} if the value is
     ...
     * @return Long one entry per input value holding its estimated rank. An entry is {@code -1} if the value is smaller than
     *         the minimum observation and equal to the number of observations if it is larger than the maximum.
     */
     ...
     * @return Long a single-element list holding the estimated reverse rank of the value. The reverse rank is {@code -1} if the
     ...
     * @return Long one entry per input value holding its estimated reverse rank. An entry is {@code -1} if the value is larger
     *         than the maximum observation and equal to the number of observations if it is smaller than the minimum.
     */
