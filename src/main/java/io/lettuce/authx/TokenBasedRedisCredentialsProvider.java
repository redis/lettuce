...
public class TokenBasedRedisCredentialsProvider implements RedisCredentialsProvider, AutoCloseable {
     ...
     * @deprecated since 7.8, use {@link #resolveCredentialsAsync()} instead; scheduled for removal in a future major release.
     */
    @Deprecated
    @Override
     ...
     * @deprecated since 7.8, use {@link #subscribeToCredentials(java.util.function.Consumer, java.util.function.Consumer)}
