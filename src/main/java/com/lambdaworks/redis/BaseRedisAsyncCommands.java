 ...
 * @author Will Glozer
 */
public abstract class BaseRedisAsyncCommands<K, V> implements RedisHashesAsyncConnection<K, V>, RedisKeysAsyncConnection<K, V>,
        ...
        RedisHLLAsyncConnection<K, V>, BaseRedisAsyncConnection<K, V>, RedisTransactionalAsyncConnection<K, V>,
     ...
     *
     */
    public BaseRedisAsyncCommands(StatefulConnection<K, V> connection, RedisCodec<K, V> codec) {
