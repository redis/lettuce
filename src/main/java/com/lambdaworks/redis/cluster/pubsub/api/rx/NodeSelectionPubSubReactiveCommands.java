...
public interface NodeSelectionPubSubReactiveCommands<K, V> {
     ...
     */
    ReactiveExecutions<Success> psubscribe(K... patterns);
     ...
     */
    ReactiveExecutions<Success> punsubscribe(K... patterns);
     ...
     */
    ReactiveExecutions<Success> subscribe(K... channels);
     ...
     */
    ReactiveExecutions<Success> unsubscribe(K... channels);
}
