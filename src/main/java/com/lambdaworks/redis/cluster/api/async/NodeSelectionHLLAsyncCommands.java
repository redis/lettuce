...
public interface NodeSelectionHLLAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<Long> pfadd(K key, V value, V... moreValues);
     ...
     */
    AsyncExecutions<Long> pfmerge(K destkey, K sourcekey, K... moreSourceKeys);
     ...
     */
    AsyncExecutions<Long> pfcount(K key, K... moreKeys);
}
