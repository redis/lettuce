...
public interface NodeSelectionStreamAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<Long> xack(K key, String group, String... messageIds);
     ...
     */
    AsyncExecutions<StreamMessage<K, V>> xclaim(K key, Consumer consumer, XClaimArgs args, String... messageIds);
     ...
     */
    AsyncExecutions<Boolean> xgroupCreate(K key, String group, String offset);
     ...
     */
    AsyncExecutions<Boolean> xgroupDelconsumer(K key, Consumer consumer);
     ...
     */
    AsyncExecutions<Boolean> xgroupSetid(K key, String group, String offset);
     ...
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xpending(K key, String group);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xpending(K key, Consumer consumer);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xpending(K key, String group, Range<String> range, Limit limit);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xpending(K key, Consumer consumer, Range<String> range, Limit limit);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xread(XReadArgs.StreamOffset<K>... streams);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xread(XReadArgs args, XReadArgs.StreamOffset<K>... streams);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xreadgroup(Consumer consumer, StreamOffset<K>... streams);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    AsyncExecutions<List<StreamMessage<K, V>>> xreadgroup(Consumer consumer, XReadArgs args,
