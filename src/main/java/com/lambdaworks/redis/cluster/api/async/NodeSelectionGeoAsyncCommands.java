...
public interface NodeSelectionGeoAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<Long> geoadd(K key, double latitude, double longitude, V member);
     ...
     * @return Long integer-reply the number of elements that were added to the set
     */
    AsyncExecutions<Long> geoadd(K key, Object... latLonMember);
     ...
     * @return bulk reply
     */
    AsyncExecutions<Set<V>> georadius(K key, double latitude, double longitude, double distance, GeoArgs.Unit unit);
     ...
     */
    AsyncExecutions<List<Object>> georadius(K key, double latitude, double longitude, double distance, GeoArgs.Unit unit,
            GeoArgs geoArgs);
     ...
     */
    AsyncExecutions<List<Object>> geoencode(double latitude, double longitude);
     ...
     *         your geohash, 3: The maximum corner of your geohash, 4: The averaged center of your geohash.
     */
    AsyncExecutions<List<Object>> geoencode(double latitude, double longitude, double distance, GeoArgs.Unit unit);
