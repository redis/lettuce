...
public interface NodeSelectionGeoAsyncCommands<K, V> {
     ...
     */
    AsyncExecutions<GeoEncoded> geoencode(double longitude, double latitude);
     ...
     */
    AsyncExecutions<GeoEncoded> geoencode(double longitude, double latitude, double distance, GeoArgs.Unit unit);
     ...
     */
    AsyncExecutions<GeoEncoded> geodecode(long geohash);
}
