...
public interface RedisStreamCommands<K, V> {
     ...
     */
    String xgroupDelconsumer(K key, Consumer consumer);
     ...
     */
    String xgroupSetid(K key, String group, String offset);
     ...
     */
    List<StreamMessage<K, V>> xpending(K key, String group);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    List<StreamMessage<K, V>> xpending(K key, Consumer consumer);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    List<PendingEntry> xpending(K key, String group, Range<String> range, Limit limit);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    List<PendingEntry> xpending(K key, Consumer consumer, Range<String> range, Limit limit);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    List<StreamMessage<K, V>> xreadgroup(Consumer consumer, XReadArgs.StreamOffset<K>... streams);
