 ...
 */
public interface RedisSetsRxConnection<K, V> {
     ...
     * @return Set&lt;V&gt; array-reply list with members of the resulting set.
     */
    Observable<Set<V>> sinter(K... keys);
     ...
     */
    Observable<Set<V>> smembers(K key);
     ...
     */
    Observable<Set<V>> srandmember(K key, long count);
     ...
     * @return Set&lt;V&gt; array-reply list with members of the resulting set.
     */
    Observable<Set<V>> sunion(K... keys);
