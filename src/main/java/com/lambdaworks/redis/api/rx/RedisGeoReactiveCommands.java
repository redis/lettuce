...
public interface RedisGeoReactiveCommands<K, V> {
     ...
     */
    Observable<String> geohash(K key, V... members);
     ...
     */
    Observable<GeoWithin<V>> georadius(K key, double longitude, double latitude, double distance, GeoArgs.Unit unit, GeoArgs geoArgs);
