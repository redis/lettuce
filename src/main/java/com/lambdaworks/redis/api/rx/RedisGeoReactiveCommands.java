...
public interface RedisGeoReactiveCommands<K, V> {
     ...
     */
    Observable<Long> georadius(K key, double longitude, double latitude, double distance, GeoArgs.Unit unit,
     ...
     * @return Long integer-reply the number of elements in the result
     */
    Observable<Long> georadiusbymember(K key, V member, double distance, GeoArgs.Unit unit,
            GeoRadiusStoreArgs<K> geoRadiusStoreArgs);
