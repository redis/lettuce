 ...
 */
public interface RedisServerRxConnection<K, V> {
     ...
     */
    Observable<List<Object>> command();
     ...
     * @return List&lt;Object&gt; array-reply
     */
    Observable<List<Object>> commandInfo(String... commands);
     ...
     * @return List&lt;Object&gt; array-reply
     */
    Observable<List<Object>> commandInfo(CommandType... commands);
     ...
     */
    Observable<List<String>> configGet(String parameter);
     ...
     */
    Observable<List<Object>> slowlogGet();
     ...
     * @return List&lt;Object&gt; deeply nested multi bulk replies
     */
    Observable<List<Object>> slowlogGet(int count);
