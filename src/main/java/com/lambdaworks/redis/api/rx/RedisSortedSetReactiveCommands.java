...
public interface RedisSortedSetReactiveCommands<K, V> {
     ...
     * @since 4.5
     */
    Observable<KeyValue<K, ScoredValue<V>>> bzpopmin(long timeout, K... keys);
     ...
     * @since 4.5
     */
    Observable<KeyValue<K, ScoredValue<V>>> bzpopmax(long timeout, K... keys);
     ...
     * @since 4.3
     */
    Observable<Double> zaddincr(K key, ZAddArgs zAddArgs, double score, V member);
     ...
     * @since 4.3
     */
    Observable<Long> zcount(K key, Range<? extends Number> range);
     ...
     *         as string.
     */
    Observable<Double> zincrby(K key, double amount, V member);
     ...
     * @since 4.3
     */
    Observable<Long> zlexcount(K key, Range<? extends V> range);
     ...
     * @since 4.5
     */
    Observable<ScoredValue<V>> zpopmin(K key);
     ...
     * @since 4.5
     */
    Observable<ScoredValue<V>> zpopmin(K key, long count);
     ...
     * @since 4.5
     */
    Observable<ScoredValue<V>> zpopmax(K key);
     ...
     * @since 4.5
     */
    Observable<ScoredValue<V>> zpopmax(K key, long count);
     ...
     * @since 4.3
     */
    Observable<V> zrangebylex(K key, Range<? extends V> range);
     ...
     * @since 4.3
     */
    Observable<V> zrangebylex(K key, Range<? extends V> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<V> zrangebyscore(K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<V> zrangebyscore(K key, Range<? extends Number> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<Long> zrangebyscore(ValueStreamingChannel<V> channel, K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<Long> zrangebyscore(ValueStreamingChannel<V> channel, K key, Range<? extends Number> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<ScoredValue<V>> zrangebyscoreWithScores(K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<ScoredValue<V>> zrangebyscoreWithScores(K key, Range<? extends Number> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<Long> zrangebyscoreWithScores(ScoredValueStreamingChannel<V> channel, K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<Long> zrangebyscoreWithScores(ScoredValueStreamingChannel<V> channel, K key, Range<? extends Number> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<Long> zremrangebylex(K key, Range<? extends V> range);
     ...
     * @since 4.3
     */
    Observable<Long> zremrangebyscore(K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<V> zrevrangebylex(K key, Range<? extends V> range);
     ...
     * @since 4.3
     */
    Observable<V> zrevrangebylex(K key, Range<? extends V> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<V> zrevrangebyscore(K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<V> zrevrangebyscore(K key, Range<? extends Number> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<Long> zrevrangebyscore(ValueStreamingChannel<V> channel, K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<Long> zrevrangebyscore(ValueStreamingChannel<V> channel, K key, Range<? extends Number> range, Limit limit);
     ...
     * @since 4.3
     */
    Observable<ScoredValue<V>> zrevrangebyscoreWithScores(K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<ScoredValue<V>> zrevrangebyscoreWithScores(K key, Range<? extends Number> range, Limit limit);
     ...
     * @return Long count of elements in the specified range.
     */
    Observable<Long> zrevrangebyscoreWithScores(ScoredValueStreamingChannel<V> channel, K key, Range<? extends Number> range);
     ...
     * @since 4.3
     */
    Observable<Long> zrevrangebyscoreWithScores(ScoredValueStreamingChannel<V> channel, K key, Range<? extends Number> range, Limit limit);
