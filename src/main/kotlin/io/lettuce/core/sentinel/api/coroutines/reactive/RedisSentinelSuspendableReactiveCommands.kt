...
package io.lettuce.core.sentinel.api.coroutines.reactive
...
internal class RedisSentinelSuspendableReactiveCommands<K, V>(private val ops: RedisSentinelReactiveCommands<K, V>) : RedisSentinelSuspendableCommands<K, V> {
     ...
     * 
     **/
    override suspend fun getMasterAddrByName(key: K?): SocketAddress? = ops.getMasterAddrByName(key).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun masters(): List<Map<K, V>>? = ops.masters().collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun master(key: K?): Map<K, V>? = ops.master(key).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun slaves(key: K?): List<Map<K, V>>? = ops.slaves(key).collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun reset(key: K?): Long? = ops.reset(key).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun failover(key: K?): String? = ops.failover(key).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun monitor(key: K?, ip: String?, port: Int, quorum: Int): String? = ops.monitor(key, ip, port, quorum).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun set(key: K?, option: String?, value: V?): String? = ops.set(key, option, value).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun remove(key: K?): String? = ops.remove(key).awaitFirstOrNull()
