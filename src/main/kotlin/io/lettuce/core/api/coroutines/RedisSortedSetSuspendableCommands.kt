...
interface RedisSortedSetSuspendableCommands<K, V> {
     ...
     * @since 5.1
     */
    suspend fun zpopmin(key: K, count: Long): Flow<ScoredValue<V>>
     ...
     * @since 5.1
     */
    suspend fun zpopmax(key: K, count: Long): Flow<ScoredValue<V>>
     ...
     * @return List<V> array-reply list of elements in the specified range.
     */
    suspend fun zrangeWithScores(key: K, start: Long, stop: Long): Flow<ScoredValue<V>>
     ...
     * @since 4.3
     */
    suspend fun zrangebyscoreWithScores(key: K, range: Range<out Number>): Flow<ScoredValue<V>>
     ...
     * @since 4.3
     */
    suspend fun zrangebyscoreWithScores(key: K, range: Range<out Number>, limit: Limit): Flow<ScoredValue<V>>
     ...
     * @return List<V> array-reply list of elements in the specified range.
     */
    suspend fun zrevrange(key: K, start: Long, stop: Long): Flow<V>
     ...
     * @return List<V> array-reply list of elements in the specified range.
     */
    suspend fun zrevrangeWithScores(key: K, start: Long, stop: Long): Flow<ScoredValue<V>>
     ...
     * @since 4.3
     */
    suspend fun zrevrangebylex(key: K, range: Range<out V>): Flow<V>
     ...
     * @since 4.3
     */
    suspend fun zrevrangebylex(key: K, range: Range<out V>, limit: Limit): Flow<V>
     ...
     * @since 4.3
     */
    suspend fun zrevrangebyscore(key: K, range: Range<out Number>): Flow<V>
     ...
     * @since 4.3
     */
    suspend fun zrevrangebyscore(key: K, range: Range<out Number>, limit: Limit): Flow<V>
     ...
     * @since 4.3
     */
    suspend fun zrevrangebyscoreWithScores(key: K, range: Range<out Number>): Flow<ScoredValue<V>>
     ...
     * @since 4.3
     */
    suspend fun zrevrangebyscoreWithScores(key: K, range: Range<out Number>, limit: Limit): Flow<ScoredValue<V>>
