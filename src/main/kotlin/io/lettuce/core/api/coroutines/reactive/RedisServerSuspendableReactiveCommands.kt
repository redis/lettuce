...
internal class RedisServerSuspendableReactiveCommands<K, V>(private val ops: RedisServerReactiveCommands<K, V>) : RedisServerSuspendableCommands<K, V> {
     ...
     * 
     **/
    override suspend fun command(): List<Any>? = ops.command().collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun commandInfo(vararg commands: String?): List<Any>? = ops.commandInfo(*commands).collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun commandInfo(vararg commands: CommandType?): List<Any>? = ops.commandInfo(*commands).collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun debugOom(): Unit? = ops.debugOom().awaitFirstOrNull().let { Unit }
     ...
     * 
     **/
    override suspend fun debugSegfault(): Unit? = ops.debugSegfault().awaitFirstOrNull().let { Unit }
     ...
     * 
     **/
    override suspend fun shutdown(save: Boolean): Unit? = ops.shutdown(save).awaitFirstOrNull().let { Unit }
     ...
     * 
     **/
    override suspend fun slowlogGet(): List<Any>? = ops.slowlogGet().collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun slowlogGet(count: Int): List<Any>? = ops.slowlogGet(count).collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun time(): List<V>? = ops.time().collectList().awaitFirstOrNull()
