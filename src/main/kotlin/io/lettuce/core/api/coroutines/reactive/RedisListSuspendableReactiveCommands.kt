...
internal class RedisListSuspendableReactiveCommands<K, V>(private val ops: RedisListReactiveCommands<K, V>) : RedisListSuspendableCommands<K, V> {
     ...
     * 
     **/
    override suspend fun lrange(channel: ValueStreamingChannel<V>?, key: K?, start: Long, stop: Long): Long? = ops.lrange(channel, key, start, stop).awaitFirstOrNull()
