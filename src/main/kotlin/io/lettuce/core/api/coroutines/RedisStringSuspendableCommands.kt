...
interface RedisStringSuspendableCommands<K, V> {
     ...
     * 
     **/
    suspend fun mget(vararg keys: K?): List<KeyValue<K, V>>?
     ...
     * 
     **/
    suspend fun mget(channel: KeyValueStreamingChannel<K, V>?, vararg keys: K?): Long?
