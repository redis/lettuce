...
/**
 * Coroutine executed commands (based on reactive commands) for Scripting. {@link java.lang.String Lua scripts} are encoded by using the configured
...
internal class RedisScriptingSuspendableReactiveCommands<K, V>(private val ops: RedisScriptingReactiveCommands<K, V>) : RedisScriptingSuspendableCommands<K, V> {
     ...
     * 
     **/
    override suspend fun scriptExists(vararg digests: String?): List<Boolean>? = ops.scriptExists(*digests).collectList().awaitFirstOrNull()
