...
internal class RedisGeoSuspendableReactiveCommands<K, V>(private val ops: RedisGeoReactiveCommands<K, V>) : RedisGeoSuspendableCommands<K, V> {
     ...
     * 
     **/
    override suspend fun geohash(key: K?, vararg members: V?): List<Value<String>>? = ops.geohash(key, *members).collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun georadius(key: K?, longitude: Double, latitude: Double, distance: Double, unit: GeoArgs.Unit?): Set<V>? = ops.georadius(key, longitude, latitude, distance, unit).collectList().awaitFirstOrNull()?.toSet()
     ...
     * 
     **/
    override suspend fun georadius(key: K?, longitude: Double, latitude: Double, distance: Double, unit: GeoArgs.Unit?, geoArgs: GeoArgs?): List<GeoWithin<V>>? = ops.georadius(key, longitude, latitude, distance, unit, geoArgs).collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun georadiusbymember(key: K?, member: V?, distance: Double, unit: GeoArgs.Unit?): Set<V>? = ops.georadiusbymember(key, member, distance, unit).collectList().awaitFirstOrNull()?.toSet()
     ...
     * 
     **/
    override suspend fun georadiusbymember(key: K?, member: V?, distance: Double, unit: GeoArgs.Unit?, geoArgs: GeoArgs?): List<GeoWithin<V>>? = ops.georadiusbymember(key, member, distance, unit, geoArgs).collectList().awaitFirstOrNull()
