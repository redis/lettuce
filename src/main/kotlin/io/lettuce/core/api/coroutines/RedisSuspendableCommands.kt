...
interface RedisSuspendableCommands<K, V> :
        ...
        RedisHLLSuspendableCommands<K, V>,
        RedisKeySuspendableCommands<K, V>,
        RedisListSuspendableCommands<K, V>,
        RedisScriptingSuspendableCommands<K, V>,
        RedisServerSuspendableCommands<K, V>,
     ...
     */
    val statefulConnection: StatefulRedisConnection<K, V>
}