...
interface RedisGeoSuspendableCommands<K, V> {
     ...
     * 
     **/
    suspend fun geohash(key: K?, vararg members: V?): List<Value<String>>?
     ...
     * 
     **/
    suspend fun georadius(key: K?, longitude: Double, latitude: Double, distance: Double, unit: GeoArgs.Unit?): Set<V>?
     ...
     * 
     **/
    suspend fun georadius(key: K?, longitude: Double, latitude: Double, distance: Double, unit: GeoArgs.Unit?, geoArgs: GeoArgs?): List<GeoWithin<V>>?
     ...
     * 
     **/
    suspend fun georadiusbymember(key: K?, member: V?, distance: Double, unit: GeoArgs.Unit?): Set<V>?
     ...
     * 
     **/
    suspend fun georadiusbymember(key: K?, member: V?, distance: Double, unit: GeoArgs.Unit?, geoArgs: GeoArgs?): List<GeoWithin<V>>?
