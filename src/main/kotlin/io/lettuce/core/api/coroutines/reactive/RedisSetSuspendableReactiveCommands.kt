...
internal class RedisSetSuspendableReactiveCommands<K, V>(private val ops: RedisSetReactiveCommands<K, V>) : RedisSetSuspendableCommands<K, V> {
     ...
     * 
     **/
    override suspend fun sdiff(vararg keys: K?): Set<V>? = ops.sdiff(*keys).collectList().awaitFirstOrNull()?.toSet()
     ...
     * 
     **/
    override suspend fun sdiff(channel: ValueStreamingChannel<V>?, vararg keys: K?): Long? = ops.sdiff(channel, *keys).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun sinter(vararg keys: K?): Set<V>? = ops.sinter(*keys).collectList().awaitFirstOrNull()?.toSet()
     ...
     * 
     **/
    override suspend fun sinter(channel: ValueStreamingChannel<V>?, vararg keys: K?): Long? = ops.sinter(channel, *keys).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun smembers(key: K?): Set<V>? = ops.smembers(key).collectList().awaitFirstOrNull()?.toSet()
     ...
     * 
     **/
    override suspend fun smembers(channel: ValueStreamingChannel<V>?, key: K?): Long? = ops.smembers(channel, key).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun spop(key: K?, count: Long): Set<V>? = ops.spop(key, count).collectList().awaitFirstOrNull()?.toSet()
     ...
     * 
     **/
    override suspend fun srandmember(key: K?, count: Long): List<V>? = ops.srandmember(key, count).collectList().awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun srandmember(channel: ValueStreamingChannel<V>?, key: K?, count: Long): Long? = ops.srandmember(channel, key, count).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun sunion(vararg keys: K?): Set<V>? = ops.sunion(*keys).collectList().awaitFirstOrNull()?.toSet()
     ...
     * 
     **/
    override suspend fun sunion(channel: ValueStreamingChannel<V>?, vararg keys: K?): Long? = ops.sunion(channel, *keys).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?): StreamScanCursor? = ops.sscan(channel, key).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?, scanArgs: ScanArgs?): StreamScanCursor? = ops.sscan(channel, key, scanArgs).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?, scanCursor: ScanCursor?, scanArgs: ScanArgs?): StreamScanCursor? = ops.sscan(channel, key, scanCursor, scanArgs).awaitFirstOrNull()
     ...
     * 
     **/
    override suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?, scanCursor: ScanCursor?): StreamScanCursor? = ops.sscan(channel, key, scanCursor).awaitFirstOrNull()
