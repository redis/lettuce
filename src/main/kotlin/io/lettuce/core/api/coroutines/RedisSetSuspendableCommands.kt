...
interface RedisSetSuspendableCommands<K, V> {
     ...
     * 
     **/
    suspend fun sdiff(channel: ValueStreamingChannel<V>?, vararg keys: K?): Long?
     ...
     * 
     **/
    suspend fun sinter(channel: ValueStreamingChannel<V>?, vararg keys: K?): Long?
     ...
     * 
     **/
    suspend fun smembers(channel: ValueStreamingChannel<V>?, key: K?): Long?
     ...
     * 
     **/
    suspend fun srandmember(channel: ValueStreamingChannel<V>?, key: K?, count: Long): Long?
     ...
     * 
     **/
    suspend fun sunion(channel: ValueStreamingChannel<V>?, vararg keys: K?): Long?
     ...
     * 
     **/
    suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?): StreamScanCursor?
     ...
     * 
     **/
    suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?, scanArgs: ScanArgs?): StreamScanCursor?
     ...
     * 
     **/
    suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?, scanCursor: ScanCursor?, scanArgs: ScanArgs?): StreamScanCursor?
     ...
     * 
     **/
    suspend fun sscan(channel: ValueStreamingChannel<V>?, key: K?, scanCursor: ScanCursor?): StreamScanCursor?
