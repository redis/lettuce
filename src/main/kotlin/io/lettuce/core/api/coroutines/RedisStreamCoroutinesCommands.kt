...
public interface RedisStreamCoroutinesCommands<K : Any, V : Any> {
    /**
     ...
     */
    public suspend fun xadd(key: K, body: Map<K, V>): String?
     ...
     * @return simple-reply the message Id.
     */
    public suspend fun xadd(key: K, vararg keysAndValues: Any): String?
     ...
     * @since 6.1
     */
    public suspend fun xautoclaim(key: K, args: XAutoClaimArgs<K>): ClaimedMessages<K, V>?
    ...
    public fun xclaim(
        ...
        minIdleTime: Long,
        vararg messageIds: String,
    ): Flow<StreamMessage<K, V>>

    /**
     * Gets ownership of one or multiple messages in the Pending Entries List of a given stream
     * consumer group.
     * <p>
     * Note that setting the `JUSTID` flag (calling this method with [XClaimArgs#justid]) suppresses
     * the message
    ...
    /**
     * Removes the specified entries from the stream. Returns the number of items deleted, that may
     * be different from the number
     ...
     */
    public suspend fun xdel(key: K, vararg messageIds: String): Long?
     ...
     */
    public suspend fun xgroupCreate(streamOffset: XReadArgs.StreamOffset<K>, group: K): String?
     ...
     * @since 5.2
     */
    public suspend fun xgroupCreate(
        streamOffset: XReadArgs.StreamOffset<K>,
        group: K,
     ...
     * @since 6.1
     */
    public suspend fun xgroupCreateconsumer(key: K, consumer: Consumer<K>): Boolean?
     ...
     */
    public suspend fun xgroupDelconsumer(key: K, consumer: Consumer<K>): Long?
     ...
     * @return simple-reply `true` if successful.
     */
    public suspend fun xgroupDestroy(key: K, group: K): Boolean?
     ...
     */
    public suspend fun xgroupSetid(streamOffset: XReadArgs.StreamOffset<K>, group: K): String?
     ...
     * @since 5.2
     */
    public suspend fun xinfoStream(key: K): List<Any>
     ...
     * @since 5.2
     */
    public suspend fun xinfoGroups(key: K): List<Any>
     ...
     * @since 5.2
     */
    public suspend fun xinfoConsumers(key: K, group: K): List<Any>
     ...
     */
    public suspend fun xlen(key: K): Long?
     ...
     */
    public suspend fun xpending(key: K, group: K): PendingMessages?
     ...
     * @since 6.1
     */
    public fun xpending(key: K, args: XPendingArgs<K>): Flow<PendingMessage>
     ...
     */
    public fun xrange(key: K, range: Range<String>): Flow<StreamMessage<K, V>>
     ...
     * @return List<StreamMessage> array-reply list with members of the resulting stream.
     */
    public fun xread(vararg streams: XReadArgs.StreamOffset<K>): Flow<StreamMessage<K, V>>
     ...
     * @return List<StreamMessage> array-reply list with members of the resulting stream.
     */
    public fun xread(args: XReadArgs, vararg streams: XReadArgs.StreamOffset<K>):
            Flow<StreamMessage<K, V>>
     ...
     * @return List<StreamMessage> array-reply list with members of the resulting stream.
     */
    public fun xreadgroup(consumer: Consumer<K>, vararg streams: XReadArgs.StreamOffset<K>):
            Flow<StreamMessage<K, V>>
     ...
     * @return List<StreamMessage> array-reply list with members of the resulting stream.
     */
    public fun xreadgroup(
        consumer: Consumer<K>,
        args: XReadArgs,
        vararg streams: XReadArgs.StreamOffset<K>,
    ): Flow<StreamMessage<K, V>>
     ...
     * @return List<StreamMessage> array-reply list with members of the resulting stream.
     */
    public fun xrevrange(key: K, range: Range<String>): Flow<StreamMessage<K, V>>
     ...
     * @return simple-reply number of removed entries.
     */
    public suspend fun xtrim(key: K, count: Long): Long?
     ...
     * @since 6.1
     */
    public suspend fun xtrim(key: K, args: XTrimArgs): Long?
}
