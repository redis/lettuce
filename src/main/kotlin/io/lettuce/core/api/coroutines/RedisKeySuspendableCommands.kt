...
interface RedisKeySuspendableCommands<K, V> {
     ...
     * 
     **/
    suspend fun keys(pattern: K?): List<K>?
     ...
     * 
     **/
    suspend fun keys(channel: KeyStreamingChannel<K>?, pattern: K?): Long?
     ...
     * 
     **/
    suspend fun sort(channel: ValueStreamingChannel<V>?, key: K?): Long?
     ...
     * 
     **/
    suspend fun sort(key: K?, sortArgs: SortArgs?): List<V>?
     ...
     * 
     **/
    suspend fun sort(channel: ValueStreamingChannel<V>?, key: K?, sortArgs: SortArgs?): Long?
     ...
     * 
     **/
    suspend fun scan(channel: KeyStreamingChannel<K>?): StreamScanCursor?
     ...
     * 
     **/
    suspend fun scan(channel: KeyStreamingChannel<K>?, scanArgs: ScanArgs?): StreamScanCursor?
     ...
     * 
     **/
    suspend fun scan(channel: KeyStreamingChannel<K>?, scanCursor: ScanCursor?, scanArgs: ScanArgs?): StreamScanCursor?
     ...
     * 
     **/
    suspend fun scan(channel: KeyStreamingChannel<K>?, scanCursor: ScanCursor?): StreamScanCursor?
