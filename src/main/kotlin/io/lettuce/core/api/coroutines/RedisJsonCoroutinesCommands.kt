...
interface RedisJsonCoroutinesCommands<K : Any, V : Any> {
     ...
     */
    suspend fun jsonMerge(key: K, jsonPath: JsonPath, value: JsonValue<V>): Boolean?
     ...
     * @since 6.5
     */
    suspend fun jsonSet(key: K, jsonPath: JsonPath, value: JsonValue<V>, options: JsonSetArgs): Boolean?
