...
public interface RedisHLLCoroutinesCommands<K : Any, V : Any> {
    /**
     ...
     */
    public suspend fun pfadd(key: K, vararg values: V): Long?
     ...
     */
    public suspend fun pfmerge(destkey: K, vararg sourcekeys: K): String?
     ...
     */
    public suspend fun pfcount(vararg keys: K): Long?
}
