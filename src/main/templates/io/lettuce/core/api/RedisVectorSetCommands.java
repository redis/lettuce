...
public interface RedisVectorSetCommands<K, V> {
     ...
     */
    @Experimental
    Boolean vadd(K key, V element, Float... vectors);
     ...
     */
    @Experimental
    Boolean vadd(K key, int dimensionality, V element, Float... vectors);
     ...
     */
    @Experimental
    Boolean vadd(K key, V element, VAddArgs args, Float... vectors);
     ...
     */
    @Experimental
    Boolean vadd(K key, int dimensionality, V element, VAddArgs args, Float... vectors);
     ...
     */
    @Experimental
    List<Float> vemb(K key, V element);
     ...
     */
    @Experimental
    List<V> vsim(K key, Float... vectors);
     ...
     */
    @Experimental
    List<V> vsim(K key, VSimArgs args, Float... vectors);
     ...
     */
    @Experimental
    Map<V, Integer> vsimWithScore(K key, Float... vectors);
     ...
     */
    @Experimental
    Map<V, Integer> vsimWithScore(K key, V element);
     ...
     */
    @Experimental
    Map<V, Integer> vsimWithScore(K key, VSimArgs args, Float... vectors);
     ...
     */
    @Experimental
    Map<V, Integer> vsimWithScore(K key, V element, VSimArgs args);
